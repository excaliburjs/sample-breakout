...
(()=>{// EXPORTS
i.d(s,{fWn:()=>/* reexport */sR,Ia8:()=>/* reexport */sg,rqv:()=>/* reexport */rQ,hLI:()=>/* reexport */sk,yyv:()=>/* reexport */rw,tX5:()=>/* reexport */t1,vtX:()=>/* reexport */sU,r7K:()=>/* reexport */se,lCh:()=>/* reexport */s6,cE4:()=>/* reexport */eP,fwF:()=>/* reexport */Animation,sce:()=>/* reexport */ta,AQ6:()=>/* reexport */ru,_c7:()=>/* reexport */th,KUs:()=>/* reexport */rh,Ajp:()=>/* reexport */ia,dkO:()=>/* reexport */O,RDh:()=>/* reexport */tn,_H9:()=>/* reexport */ti,mxs:()=>/* reexport */sE,OmD:()=>/* reexport */st,kBf:()=>/* reexport */ex,C4F:()=>/* reexport */Y,NQt:()=>/* reexport */rk,JjN:()=>/* reexport */rM,EK_:()=>/* reexport */U,V1s:()=>/* reexport */s1,xHm:()=>/* reexport */s0,Xz7:()=>/* reexport */im,Cdc:()=>/* reexport */su,FKn:()=>/* reexport */i2,SUY:()=>/* reexport */rN,ab2:()=>/* reexport */i0,GfZ:()=>/* reexport */i1,YMS:()=>/* reexport */i$,oyv:()=>/* reexport */i8,aUb:()=>/* reexport */i5,SdD:()=>/* reexport */tJ,JUv:()=>/* reexport */iG,jEj:()=>/* reexport */r0,TFq:()=>/* reexport */i3,HDU:()=>/* reexport */t$,R_y:()=>/* reexport */tj,ydN:()=>/* reexport */K,t50:()=>/* reexport */tQ,s$$:()=>/* reexport */rc,v2G:()=>/* reexport */Z,Ilk:()=>/* reexport */ef,s9i:()=>/* reexport */rD,dxL:()=>/* reexport */tc,LLX:()=>/* reexport */rI,wA2:()=>/* reexport */iO,R_p:()=>/* reexport */iQ,IQ$:()=>/* reexport */r_,I5F:()=>/* reexport */t8,X8$:()=>/* reexport */rl,FR6:()=>/* reexport */tY,U8o:()=>/* reexport */tK,kbG:()=>/* reexport */$,iS_:()=>/* reexport */t2,cGG:()=>/* reexport */rB,RPN:()=>/* reexport */sV,skb:()=>/* reexport */rx,SLU:()=>/* reexport */eH,RdJ:()=>/* reexport */Q,cNu:()=>/* reexport */sI,gU7:()=>/* reexport */iI,LSk:()=>/* reexport */sD,Nmp:()=>/* reexport */tr,d1Y:()=>/* reexport */X,xrL:()=>/* reexport */iK,sRW:()=>/* reexport */ij,cmV:()=>/* binding */nl,qWz:()=>/* reexport */sT,N0Q:()=>/* reexport */sS,q8b:()=>/* reexport */s_,ynB:()=>/* reexport */i6,jT9:()=>/* reexport */s$,wAz:()=>/* reexport */tl,D4V:()=>/* reexport */rZ,NLr:()=>/* reexport */rX,N6H:()=>/* reexport */t3,W1A:()=>/* reexport */t4,JHW:()=>/* reexport */so,ZZ$:()=>/* reexport */sn,v2K:()=>/* reexport */rt,pBf:()=>/* reexport */rK,vpe:()=>/* reexport */tS,GMl:()=>/* reexport */z,zW2:()=>/* reexport */tf,B0K:()=>/* reexport */iv,Nv7:()=>/* reexport */is,C_p:()=>/* reexport */ie,MUA:()=>/* reexport */t6,xqU:()=>/* reexport */t5,pTp:()=>/* reexport */sP,vUK:()=>/* reexport */tC,j9l:()=>/* reexport */sB,Zxw:()=>/* reexport */sz,v51:()=>/* reexport */sL,Hdx:()=>/* reexport */ts,Z$d:()=>/* reexport */tt,iqV:()=>/* reexport */rO,o$7:()=>/* reexport */rF,olM:()=>/* reexport */ey,Zm$:()=>/* reexport */tT,$QH:()=>/* reexport */tD,i78:()=>/* reexport */tB,nJg:()=>/* reexport */Gamepad,h6u:()=>/* reexport */tV,hts:()=>/* reexport */tW,j88:()=>/* reexport */tN,VME:()=>/* reexport */tH,fy2:()=>/* reexport */t9,nt:()=>/* reexport */r8,Ukr:()=>/* reexport */rL,zsu:()=>/* reexport */eM,oA6:()=>/* reexport */sd,TVh:()=>/* reexport */rp,TwZ:()=>/* reexport */sh,GTT:()=>/* reexport */sl,xxj:()=>/* reexport */rv,XdK:()=>/* reexport */tq,Jmb:()=>/* reexport */q,cXo:()=>/* reexport */eU,Dm5:()=>/* reexport */t0,IIB:()=>/* reexport */ty,ebW:()=>/* reexport */rq,zI0:()=>/* reexport */j,LYD:()=>/* reexport */rb,cEG:()=>/* reexport */rC,SEl:()=>/* reexport */r$,t9V:()=>/* reexport */rj,ez5:()=>/* reexport */ei,N1d:()=>/* reexport */es,R8U:()=>/* reexport */H,SKZ:()=>/* reexport */tE,__J:()=>/* reexport */rY,RI$:()=>/* reexport */sJ,x12:()=>/* reexport */nn,ccz:()=>/* reexport */iJ,aNw:()=>/* reexport */iE,XrL:()=>/* reexport */iT,xwn:()=>/* reexport */sj,dNK:()=>/* reexport */sY,ini:()=>/* reexport */N,YdH:()=>/* reexport */t7,F5T:()=>/* reexport */e9,y3G:()=>/* reexport */eE,l57:()=>/* reexport */G,xn0:()=>/* reexport */iw,t2V:()=>/* reexport */sF,uxB:()=>/* reexport */iV,cpd:()=>/* reexport */ra,fiy:()=>/* reexport */sv,$XZ:()=>/* reexport */sx,UG6:()=>/* reexport */tp,uqK:()=>/* reexport */ib,STE:()=>/* reexport */iC,y$z:()=>/* reexport */iH,mAD:()=>/* reexport */rA,sOq:()=>/* reexport */iq,hUw:()=>/* reexport */sW,_0G:()=>/* reexport */rJ,Sqs:()=>/* reexport */nr,hpZ:()=>/* reexport */rm,Vol:()=>/* reexport */rf,vYX:()=>/* reexport */td,wIZ:()=>/* reexport */iM,cBi:()=>/* reexport */rR,c30:()=>/* reexport */rS,MPV:()=>/* reexport */t_,RFv:()=>/* reexport */sp,Ux6:()=>/* reexport */PointerEvent,rxy:()=>/* reexport */rU,I$c:()=>/* reexport */W,kfC:()=>/* reexport */ry,VjY:()=>/* reexport */tg,mgq:()=>/* reexport */no,YVA:()=>/* reexport */i9,Kgp:()=>/* reexport */e4,HH$:()=>/* reexport */tZ,M_d:()=>/* reexport */tM,rgh:()=>/* reexport */tR,Ra6:()=>/* reexport */tO,KhR:()=>/* reexport */tI,BS5:()=>/* reexport */tz,xhz:()=>/* reexport */tX,xOq:()=>/* reexport */tk,a9j:()=>/* reexport */tF,bHk:()=>/* reexport */tU,CgK:()=>/* reexport */tP,cuY:()=>/* reexport */tL,kvE:()=>/* reexport */iX,SBu:()=>/* reexport */e0,PsT:()=>/* reexport */sG,AE_:()=>/* reexport */ri,ctO:()=>/* reexport */rs,OLH:()=>/* reexport */sQ,kky:()=>/* reexport */er,nSF:()=>/* reexport */ig,zHn:()=>/* reexport */iY,zwx:()=>/* reexport */rd,AeJ:()=>/* reexport */sc,hLz:()=>/* reexport */ss,D9g:()=>/* reexport */s7,wA:()=>/* reexport */sm,jhr:()=>/* reexport */sf,GVs:()=>/* reexport */ir,_zO:()=>/* reexport */eF,LXZ:()=>/* reexport */eB,w6$:()=>/* reexport */sw,mhV:()=>/* reexport */sy,MOD:()=>/* reexport */J,kwd:()=>/* reexport */sC,Lmr:()=>/* reexport */sb,xsS:()=>/* reexport */rE,K5l:()=>/* reexport */rT,lLr:()=>/* reexport */Screen,Z$r:()=>/* reexport */et,IXb:()=>/* reexport */sN,Xsu:()=>/* reexport */io,SGH:()=>/* reexport */rP,SMj:()=>/* reexport */tm,L34:()=>/* reexport */nh,exe:()=>/* reexport */eZ,bnF:()=>/* reexport */i7,MFA:()=>/* reexport */V,$uU:()=>/* reexport */iS,Sap:()=>/* reexport */iA,jyi:()=>/* reexport */eL,E03:()=>/* reexport */eN,V6q:()=>/* reexport */eO,rg2:()=>/* reexport */rH,DVW:()=>/* reexport */ix,nVo:()=>/* reexport */sK,F6N:()=>/* reexport */ni,xP7:()=>/* reexport */s3,Odq:()=>/* reexport */rr,Zif:()=>/* reexport */to,ZGJ:()=>/* reexport */iN,MJk:()=>/* reexport */rW,xvT:()=>/* reexport */Text,PHM:()=>/* reexport */te,dpR:()=>/* reexport */ez,n9L:()=>/* reexport */sZ,KwO:()=>/* reexport */sX,SxM:()=>/* reexport */sq,B7y:()=>/* reexport */sH,x7r:()=>/* reexport */rG,wx7:()=>/* reexport */iU,Uvn:()=>/* reexport */iW,OFT:()=>/* reexport */iZ,xzN:()=>/* reexport */s4,CcZ:()=>/* reexport */s2,M5Z:()=>/* reexport */en,ZrN:()=>/* reexport */tw,OWs:()=>/* reexport */eg,dF9:()=>/* reexport */iL,oZy:()=>/* reexport */eK,rD2:()=>/* reexport */eY,VHo:()=>/* reexport */tG,ohE:()=>/* reexport */ih,R$E:()=>/* reexport */iy,xQN:()=>/* reexport */tu,AdJ:()=>/* reexport */WheelEvent,q3I:()=>/* reexport */rn,Pab:()=>/* reexport */el,uZ5:()=>/* reexport */eh,McK:()=>/* reexport */tA,F9c:()=>/* reexport */eo,k0b:()=>/* reexport */sa,hnT:()=>/* reexport */r2,RSJ:()=>/* reexport */r6,Mku:()=>/* reexport */r4,h90:()=>/* reexport */r7,rms:()=>/* reexport */r9,ErP:()=>/* reexport */r1,aVg:()=>/* reexport */r3,lPc:()=>/* reexport */r5,Z8E:()=>/* reexport */si,_N2:()=>/* reexport */s9,yFn:()=>/* reexport */s8,lNv:()=>/* reexport */sr,cu9:()=>/* reexport */sO,MZQ:()=>/* reexport */iD,FUM:()=>/* reexport */ik,BxR:()=>/* reexport */e8,vdf:()=>/* reexport */ep,iaL:()=>/* reexport */e_,w6H:()=>/* reexport */eu,Q4c:()=>/* reexport */iF,Xxe:()=>/* reexport */ea,Uxb:()=>/* reexport */ed,Yr5:()=>/* reexport */ec,Bhw:()=>/* reexport */em,yOA:()=>/* reexport */tv});// NAMESPACE OBJECT: ./Events.ts
...
f.trySetUniformFloatVector("u_resolution",em(this._context.width,this._context.height)),// apply size
 ...
 */class iG{/**
     ...
     */invert(){return new iG("~("+this.name+")",~this.category,~this.mask)}/**
     * Combine collision groups with each other. The new group includes all of the previous groups.
     * @param collisionGroups
     */static combine(t){let e=t.map(t=>t.name).join("+"),i=t.reduce((t,e)=>e.category|t,0);return new iG(e,i,~i)}/**
     * Creates a collision group that collides with the listed groups
     * @param collisionGroups
     */static collidesWith(t){return iG.combine(t).invert()}}/**
 * The `All` [[CollisionGroup]] is a special group that collides with all other groups including itself,
 * it is the default collision group on colliders.
 */iG.All=new iG("Collide with all groups",-1,-1);/**
 ...
 */class iX{constructor(t,e){this.min=t,this.max=e}overlaps(t){return this.max>t.min&&t.max>this.min}getOverlap(t){return this.overlaps(t)?this.max>t.max?t.max-this.min:this.max-t.min:0}}/**
 * Dynamic Tree Node used for tracking bounds within the tree
 */class iZ{constructor(t){this.parent=t,this.parent=t||null,this.data=null,this.bounds=new ex,this.left=null,this.right=null,this.height=0}isLeaf(){return!this.left&&!this.right}}/**
 * The DynamicTrees provides a spatial partitioning data structure for quickly querying for overlapping bounding boxes for
 * all tracked bodies. The worst case performance of this is O(n*log(n)) where n is the number of bodies in the tree.
 *
 * Internally the bounding boxes are organized as a balanced binary tree of bounding boxes, where the leaf nodes are tracked bodies.
 * Every non-leaf node is a bounding box that contains child bounding boxes.
 */class iK{constructor(t=new ex(-Number.MAX_VALUE,-Number.MAX_VALUE,Number.MAX_VALUE,Number.MAX_VALUE)){this.worldBounds=t,this.root=null,this.nodes={}}/**
...
let s=i.parent,r=new iZ(s);r.bounds=e.combine(i.bounds),r.height=i.height+1,null!==s?(s.left===i?s.left=r:s.right=r,r.left=i,r.right=t,i.parent=r,t.parent=r):(// The sibling node was the root
...
let n=t.parent;for(;n;){if(!(n=this._balance(n)).left)throw Error("Parent of current leaf cannot have a null left child"+n);if(!n.right)throw Error("Parent of current leaf cannot have a null right child"+n);n.height=1+Math.max(n.left.height,n.right.height),n.bounds=n.left.bounds.combine(n.right.bounds),n=n.parent}}/**
     ...
     */trackCollider(t){let e=new iZ;e.data=t,e.bounds=t.bounds,e.bounds.left-=2,e.bounds.top-=2,e.bounds.right+=2,e.bounds.bottom+=2,this.nodes[t.id.value]=e,this._insert(e)}/**
...
if(this._remove(i),s.left-=iM.boundsPadding,s.top-=iM.boundsPadding,s.right+=iM.boundsPadding,s.bottom+=iM.boundsPadding,t.owner){let i=null===(e=t.owner)||void 0===e?void 0:e.get(st);if(i){let t=32*i.vel.x/1e3*iM.dynamicTreeVelocityMultiplier,e=32*i.vel.y/1e3*iM.dynamicTreeVelocityMultiplier;t<0?s.left+=t:s.right+=t,e<0?s.top+=e:s.bottom+=e}}return i.bounds=s,this._insert(i),!0}/**
 ...
 */class ij{constructor(){this._dynamicCollisionTree=new iK,this._pairs=new Set,this._collisionPairCache=[],this._colliders=[]}getColliders(){return this._colliders}rayCast(t,e){var i,s,r;let n=[],o=null!==(i=null==e?void 0:e.maxDistance)&&void 0!==i?i:1/0,a=null!==(s=null==e?void 0:e.collisionGroup)&&void 0!==s?s:iG.All,h=null!==(r=null==e?void 0:e.searchAllColliders)&&void 0!==r&&r;return this._dynamicCollisionTree.rayCastQuery(t,o,e=>{var i;let s=e.owner,r=s.get(st);// Early exit if not the right group
if(a.mask!==iG.All.mask&&(null===(i=null==r?void 0:r.group)||void 0===i?void 0:i.mask)!==a.mask)return!1;let l=e.rayCast(t,o);return!!l&&(n.push({distance:l.sub(t.pos).distance(),point:l,collider:e,body:r}),!h)}),n}/**
     * Tracks a physics body for collisions
     */track(t){if(!t){t7.getInstance().warn("Cannot track null collider");return}if(t instanceof iQ){let e=t.getColliders();for(let i of e)i.owner=t.owner,this._colliders.push(i),this._dynamicCollisionTree.trackCollider(i)}else this._colliders.push(t),this._dynamicCollisionTree.trackCollider(t)}/**
     * Untracks a physics body
     */untrack(t){if(!t){t7.getInstance().warn("Cannot untrack a null collider");return}if(t instanceof iQ){let e=t.getColliders();for(let t of e){let e=this._colliders.indexOf(t);-1!==e&&this._colliders.splice(e,1),this._dynamicCollisionTree.untrackCollider(t)}}else{let e=this._colliders.indexOf(t);-1!==e&&this._colliders.splice(e,1),this._dynamicCollisionTree.untrackCollider(t)}}_pairExists(t,e){// if the collision pair has been calculated already short circuit
let i=iq.calculatePairHash(t.id,e.id);return this._pairs.has(i)}/**
     * Detects potential collision pairs in a broadphase approach with the dynamic AABB tree strategy
     */broadphase(t,e,i){let s;let r=e/1e3,n=t.filter(t=>{var e,i;let s=null===(e=t.owner)||void 0===e?void 0:e.get(st);return(null===(i=t.owner)||void 0===i?void 0:i.active)&&s.collisionType!==Z.PreventCollision});// clear old list of collision pairs
...
if(i&&(i.physics.pairs=this._collisionPairCache.length),iM.checkForFastBodies)for(let t of n){let e=t.owner.get(st);// Skip non-active objects. Does not make sense on other collision types
...
let n=e.globalPos.sub(e.oldPos),o=t.center,a=t.getFurthestPoint(e.vel),h=a.sub(n),l=new iY(h,e.vel);// back the ray up by -2x surfaceEpsilon to account for fast moving objects starting on the surface
l.pos=l.pos.add(l.dir.scale(-2*iM.surfaceEpsilon));let d=new eg(1/0,1/0);if(this._dynamicCollisionTree.rayCastQuery(l,s+2*iM.surfaceEpsilon,e=>{if(!this._pairExists(t,e)&&iq.canCollide(t,e)){let t=e.rayCast(l,s+10*iM.surfaceEpsilon);if(t){let i=t.sub(h);i.size<d.size&&(d=i,r=e)}}return!1}),r&&eg.isValid(d)){let s=new iq(t,r);this._pairs.has(s.id)||(this._pairs.add(s.id),this._collisionPairCache.push(s));// move the fast moving object to the other body
 ...
 */class i${constructor(){this.id=tA("collider",i$._ID++),/**
     ...
     */touching(t){let e=this.collide(t);return!!e}}i$._ID=0;class iQ extends i${constructor(t){for(let e of(super(),this._collisionProcessor=new ij,this._dynamicAABBTree=new iK,this._colliders=[],t))this.addCollider(e)}clearColliders(){this._colliders=[]}addCollider(t){t.events.pipe(this.events),t.__compositeColliderId=this.id,this._colliders.push(t),this._collisionProcessor.track(t),this._dynamicAABBTree.trackCollider(t)}removeCollider(t){t.events.pipe(this.events),t.__compositeColliderId=null,eC(t,this._colliders),this._collisionProcessor.untrack(t),this._dynamicAABBTree.untrackCollider(t)}getColliders(){return this._colliders}get worldPos(){var t,e;// TODO transform component world pos
...
let s=i[0],r=-Number.MAX_VALUE;for(let e of i){let i=e.dot(t);i>r&&(s=e,r=i)}return s}getInertia(t){let e=this.getColliders(),i=0;for(let s of e)i+=s.getInertia(t);return i}collide(t){let e=[t];t instanceof iQ&&(e=t.getColliders());let i=[];for(let t of e)this._dynamicAABBTree.query(t,e=>(i.push(new iq(t,e)),!1));let s=[];for(let t of i)s=s.concat(t.collide());return s}getClosestLineBetween(t){let e=this.getColliders(),i=[];if(t instanceof iQ){let s=t.getColliders();for(let t of e)for(let e of s){let s=t.getClosestLineBetween(e);s&&i.push(s)}}else for(let s of e){let e=t.getClosestLineBetween(s);e&&i.push(e)}if(i.length){let t=i[0].getLength(),e=i[0];for(let s of i){let i=s.getLength();i<t&&(t=i,e=s)}return e}return null}contains(t){let e=this.getColliders();for(let i of e)if(i.contains(t))return!0;return!1}rayCast(t,e){let i=this.getColliders(),s=[];for(let r of i){let i=r.rayCast(t,e);i&&s.push(i)}if(s.length){let e=s[0],i=e.dot(t.dir);for(let r of s){let s=t.dir.dot(r);s<i&&(e=r,i=s)}return e}return null}project(t){let e=this.getColliders(),i=[];for(let s of e){let e=s.project(t);e&&i.push(e)}// Merge all proj's on the same axis
if(i.length){let t=new iX(i[0].min,i[0].max);for(let e of i)t.min=Math.min(e.min,t.min),t.max=Math.max(e.max,t.max);return t}return null}update(t){if(t){let e=this.getColliders();for(let i of e)i.owner=this.owner,i.update(t)}}debug(t,e){let i=this.getColliders();for(let s of i)s.debug(t,e)}clone(){return new iQ(this._colliders.map(t=>t.clone()))}}/**
 * A 2D line segment
 */class iJ{/**
     ...
     */flip(){return new iJ(this.end,this.begin)}/**
     ...
     */clip(t,e){let i=t;i=i.normalize();let s=i.dot(this.begin)-e,r=i.dot(this.end)-e,n=[];return(s<=0&&n.push(this.begin),r<=0&&n.push(this.end),s*r<0&&n.push(this.begin.add(this.end.sub(this.begin).scale(s/(s-r)))),2!==n.length)?null:new iJ(n[0],n[1])}/**
 ...
 */function i0(t,e,i,s){// Distance between 2 lines http://geomalgorithms.com/a07-_distance.html
// w(s, t) = P(s) - Q(t)
...
if(0===d||d<=.01)return new iJ(t,i.add(s.scale(h/o)));// Solve for sClosest for infinite line
let p=o*l-a*h,_=n*l-o*h;// / denom;
return p<0?(p=0,_=l,u=a):p>c&&(p=c,_=l+o,u=a),_<0?(_=0,0>-h?p=0:-h>n?p=c:(p=-h,c=n)):_>u&&(_=u,-h+o<0?p=0:-h+o>n?p=c:(p=-h+o,c=n)),p=.001>Math.abs(p)?0:p/c,_=.001>Math.abs(_)?0:_/u,new iJ(t.add(e.scale(p)),i.add(s.scale(_)))}let i1={PolygonPolygonClosestLine(t,e){// Find the 2 closest faces on each polygon
let i=e.worldPos,s=i.sub(t.worldPos),r=s.negate(),n=new iY(t.worldPos,s),o=new iY(i,r),a=t.rayCast(n).add(n.dir.scale(.1)),h=e.rayCast(o).add(o.dir.scale(.1)),l=t.getClosestFace(a),d=e.getClosestFace(h),c=l.face.begin,u=l.face.getEdge(),p=d.face.begin,_=d.face.getEdge();return i0(c,u,p,_)},PolygonEdgeClosestLine(t,e){// Find the 2 closest faces on each polygon
let i=e.worldPos,s=i.sub(t.worldPos),r=new iY(t.worldPos,s),n=t.rayCast(r).add(r.dir.scale(.1)),o=t.getClosestFace(n),a=o.face.begin,h=o.face.getEdge(),l=e.asLine(),d=l.begin,c=l.getEdge();return i0(a,h,d,c)},PolygonCircleClosestLine(t,e){// https://math.stackexchange.com/questions/1919177/how-to-find-point-on-line-closest-to-sphere
// Find the 2 closest faces on each polygon
let i=e.worldPos,s=i.sub(t.worldPos),r=new iY(t.worldPos,s.normalize()),n=t.rayCast(r).add(r.dir.scale(.1)),o=t.getClosestFace(n),a=o.face.begin,h=o.face.getEdge(),l=(h.x*(i.x-a.x)+h.y*(i.y-a.y))/(h.x*h.x+h.y*h.y);// If time of minimum is past the edge clamp
l>1?l=1:l<0&&(l=0);// Minimum distance
let d=Math.sqrt(Math.pow(a.x+h.x*l-i.x,2)+Math.pow(a.y+h.y*l-i.y,2))-e.radius,c=(a.x+h.x*l-i.x)*e.radius/(e.radius+d),u=(a.y+h.y*l-i.y)*e.radius/(e.radius+d);return new iJ(h.scale(l).add(a),new eg(i.x+c,i.y+u))},CircleCircleClosestLine(t,e){// Find the 2 closest faces on each polygon
let i=e.worldPos,s=i.sub(t.worldPos),r=t.worldPos,n=r.sub(e.worldPos),o=new iY(t.worldPos,s),a=new iY(e.worldPos,n),h=t.rayCast(o),l=e.rayCast(a);return new iJ(h,l)},CircleEdgeClosestLine(t,e){// https://math.stackexchange.com/questions/1919177/how-to-find-point-on-line-closest-to-sphere
...
let a=Math.sqrt(Math.pow(r.x+n.x*o-i.x,2)+Math.pow(r.y+n.y*o-i.y,2))-t.radius,h=(r.x+n.x*o-i.x)*t.radius/(t.radius+a),l=(r.y+n.y*o-i.y)*t.radius/(t.radius+a);return new iJ(n.scale(o).add(r),new eg(i.x+h,i.y+l))},EdgeEdgeClosestLine(t,e){// L1 = P(s) = p0 + s * u, where s is time and p0 is the start of the line
let i=t.asLine(),s=i.begin,r=i.getEdge(),n=e.asLine(),o=n.begin,a=n.getEdge();return i0(s,r,o,a)}};/**
 * This is a circle collider for the excalibur rigid body physics simulation
 */class i2 extends i${get worldPos(){return this._globalMatrix.getPosition()}/**
...
this._naturalRadius=t/Math.min(s.x,s.y)}constructor(t){super(),/**
     ...
     */clone(){return new i2({offset:this.offset.clone(),radius:this.radius})}/**
...
let i=this.center,s=t.dir,r=t.pos,n=Math.sqrt(Math.pow(s.dot(r.sub(i)),2)-Math.pow(r.sub(i).distance(),2)+Math.pow(this.radius,2));if(n<0)return null;{let o=0;if(0===n)return(o=-s.dot(r.sub(i)))>0&&o<e?t.getPoint(o):null;{let o=-s.dot(r.sub(i))+n,a=-s.dot(r.sub(i))-n,h=[];o>=0&&h.push(o),a>=0&&h.push(a);let l=Math.min(...h);return l<=e?t.getPoint(l):null}}}getClosestLineBetween(t){if(t instanceof i2)return i1.CircleCircleClosestLine(this,t);if(t instanceof i9)return i1.PolygonCircleClosestLine(t,this).flip();if(t instanceof i6)return i1.CircleEdgeClosestLine(this,t).flip();throw Error(`Polygon could not collide with unknown CollisionShape ${typeof t}`)}/**
     * @inheritdoc
     */collide(t){if(t instanceof i2)return i3.CollideCircleCircle(this,t);if(t instanceof i9)return i3.CollideCirclePolygon(this,t);if(t instanceof i6)return i3.CollideCircleEdge(this,t);throw Error(`Circle could not collide with unknown CollisionShape ${typeof t}`)}/**
...
let o=r.normalize(),l=t.radius-Math.sqrt(n),d={collider:t,separation:l,axis:o,point:a.begin,side:a,localSide:h};return[new i5(t,e,o.scale(l),o,o.perpendicular(),[a.begin],[h.begin],d)]}// Potential region B collision (circle is on the right side of the edge, after the end)
if(n<=0){let r=s.end.sub(i),n=r.dot(r);if(n>t.radius*t.radius)return[];let o=r.normalize(),l=t.radius-Math.sqrt(n),d={collider:t,separation:l,axis:o,point:a.end,side:a,localSide:h};return[new i5(t,e,o.scale(l),o,o.perpendicular(),[a.end],[h.end],d)]}// Otherwise potential region AB collision (circle is in the middle of the edge between the beginning and end)
...
let d=[];if(h.collider===t){let t=null!==(s=null===(i=e.owner)||void 0===i?void 0:i.get(iW))&&void 0!==s?s:new iW;d=o.map(e=>t.applyInverse(e))}else{let e=null!==(n=null===(r=t.owner)||void 0===r?void 0:r.get(iW))&&void 0!==n?n:new iW;d=o.map(t=>e.applyInverse(t))}return[new i5(t,e,a.scale(-h.separation),a,l,o,d,h)]}return[]},FindContactSeparation(t,e){var i,s,r,n;let o=t.colliderA,a=null!==(s=null===(i=t.colliderA.owner)||void 0===i?void 0:i.get(iW))&&void 0!==s?s:new iW,h=t.colliderB,l=null!==(n=null===(r=t.colliderB.owner)||void 0===r?void 0:r.get(iW))&&void 0!==n?n:new iW;// both are circles
if(o instanceof i2&&h instanceof i2){let t=o.radius+h.radius,e=a.pos.distance(l.pos);return-(t-e)}// both are polygons
if(o instanceof i9&&h instanceof i9&&t.info.localSide){let i,s;return t.info.collider===o?(i=new iJ(a.apply(t.info.localSide.begin),a.apply(t.info.localSide.end)),s=l.apply(e)):(i=new iJ(l.apply(t.info.localSide.begin),l.apply(t.info.localSide.end)),s=a.apply(e)),i.distanceToPoint(s,!0)}// polygon v circle
if(o instanceof i9&&h instanceof i2||h instanceof i9&&o instanceof i2){let i=a.apply(e);if(t.info.side)return t.info.side.distanceToPoint(i,!0)}// polygon v edge
if(o instanceof i6&&h instanceof i9||h instanceof i6&&o instanceof i9){let i;if(i=t.info.collider===o?l.apply(e):a.apply(e),t.info.side)return t.info.side.distanceToPoint(i,!0)}// circle v edge
if(o instanceof i2&&h instanceof i6||h instanceof i2&&o instanceof i6){let i;// Local point is always on the edge which is always shapeB
let s=l.apply(e);o instanceof i2&&(i=o.getFurthestPoint(t.normal));let r=s.distance(i);if(t.info.side)return r>0?-r:0}return 0}};/**
 * Edge is a single line collider to create collisions with a single line.
 */class i6 extends i${constructor(t){var e;super(),this._globalMatrix=eP.identity(),this.begin=t.begin||eg.Zero,this.end=t.end||eg.Zero,this.offset=null!==(e=t.offset)&&void 0!==e?e:eg.Zero}/**
...
let s=t.dir.cross(this.getSlope());if(0===s)return null;let r=i.cross(this.getSlope())/s;if(r>=0&&r<=e){let e=i.cross(t.dir)/s/this.getLength();if(e>=0&&e<=1)return t.getPoint(r)}return null}/**
     ...
     * @param shape
     */getClosestLineBetween(t){if(t instanceof i2)return i1.CircleEdgeClosestLine(t,this);if(t instanceof i9)return i1.PolygonEdgeClosestLine(t,this).flip();if(t instanceof i6)return i1.EdgeEdgeClosestLine(this,t);throw Error(`Polygon could not collide with unknown CollisionShape ${typeof t}`)}/**
     * @inheritdoc
     */collide(t){if(t instanceof i2)return i3.CollideCircleEdge(t,this);if(t instanceof i9)return i3.CollidePolygonEdge(t,this);if(t instanceof i6)return i3.CollideEdgeEdge();throw Error(`Edge could not collide with unknown CollisionShape ${typeof t}`)}/**
     * Find the point on the collider furthest in the direction specified
...
return new ex(Math.min(t.x,e.x)-i,Math.min(t.y,e.y)-i,Math.max(t.x,e.x)+i,Math.max(t.y,e.y)+i)}/**
     ...
     */asLine(){return new iJ(this._getTransformedBegin(),this._getTransformedEnd())}/**
     * Return this edge as a line in local line coordinates (relative to the position)
     */asLocalLine(){return new iJ(this.begin,this.end)}/**
     ...
     */project(t){let e=[],i=[this._getTransformedBegin(),this._getTransformedEnd()],s=i.length;for(let r=0;r<s;r++)e.push(i[r].dot(t));return new iX(Math.min.apply(Math,e),Math.max.apply(Math,e))}debug(t,e){let i=this._getTransformedBegin(),s=this._getTransformedEnd();t.drawLine(i,s,e,2),t.drawCircle(i,2,e),t.drawCircle(s,2,e)}}/**
...
let h=i-s;if(h<=-Math.PI?h+=2*Math.PI:h>Math.PI&&(h-=2*Math.PI),0===o){if(0===h)return!1;r=h>0?1:-1}else if(r*h<=0)return!1;n+=h}return 1===Math.abs(Math.round(n/(2*Math.PI)))}/**
     ...
     */tessellate(){let t=[];for(let e=1;e<this.points.length-2;e++)t.push([this.points[0],this.points[e+1],this.points[e+2]]);return t.push([this.points[0],this.points[1],this.points[2]]),new iQ(t.map(t=>i7.Polygon(t)))}/**
...
if(_){e.push([l,h,d]),s.splice(r,1);break}}return e.push([i[s[0]],i[s[1]],i[s[2]]]),new iQ(e.map(t=>i7.Polygon(t)))}/**
     * Returns a clone of this ConvexPolygon, not associated with any collider
     */clone(){return new i9({offset:this.offset.clone(),points:this.points.map(t=>t.clone())})}/**
...
for(let i=0;i<e;i++)this._transformedPoints[i]=this._globalMatrix.multiply(t[i].clone())}/**
     ...
     */getSides(){if(this._sidesDirty){let t=[],e=this.getTransformedPoints(),i=e.length;for(let s=0;s<i;s++)t.push(new iJ(e[s],e[(s+1)%i]));this._sides=t,this._sidesDirty=!1}return this._sides}/**
     * Returns the local coordinate space sides
     */getLocalSides(){if(this._localSidesDirty){let t=[],e=this.points,i=e.length;for(let s=0;s<i;s++)t.push(new iJ(e[s],e[(s+1)%i]));this._localSides=t,this._localSidesDirty=!1}return this._localSides}/**
...
// will be fine
let e=new iY(t,new eg(1,0)),i=this.getSides().reduce(function(t,i){return e.intersect(i)>=0?t+1:t},0);return i%2!=0}getClosestLineBetween(t){if(t instanceof i2)return i1.PolygonCircleClosestLine(this,t);if(t instanceof i9)return i1.PolygonPolygonClosestLine(this,t);if(t instanceof i6)return i1.PolygonEdgeClosestLine(this,t);throw Error(`Polygon could not collide with unknown CollisionShape ${typeof t}`)}/**
     * Returns a collision contact if the 2 colliders collide, otherwise collide will
     * return null.
     * @param collider
     */collide(t){if(t instanceof i2)return i3.CollideCirclePolygon(t,this);if(t instanceof i9)return i3.CollidePolygonPolygon(this,t);if(t instanceof i6)return i3.CollidePolygonEdge(this,t);throw Error(`Polygon could not collide with unknown CollisionShape ${typeof t}`)}/**
     * Find the point on the collider furthest in the direction specified
...
n>=0?t.getPoint(r):null)}/**
     ...
     */project(t){let e=this.getTransformedPoints(),i=e.length,s=Number.MAX_VALUE,r=-Number.MAX_VALUE;for(let n=0;n<i;n++){let i=e[n].dot(t);s=Math.min(s,i),r=Math.max(r,i)}return new iX(s,r)}debug(t,e){let i=this.getTransformedPoints()[0],s=[i,...this.getTransformedPoints(),i];for(let i=0;i<s.length-1;i++)t.drawLine(s[i],s[i+1],e,2),t.drawCircle(s[i],2,e),t.drawCircle(s[i+1],2,e)}}/**
 ...
 */class i7{/**
     ...
     */static Box(t,e,i=eg.Half,s=eg.Zero){return new i9({points:new ex(-t*i.x,-e*i.y,t-t*i.x,e-e*i.y).getPoints(),offset:s})}/**
     * Creates a new [[PolygonCollider|arbitrary polygon]] collider
     *
     * PolygonColliders are useful for creating convex polygon shapes
     * @param points Points specified in counter clockwise
     * @param offset Optional offset relative to the collider in local coordinates
     */static Polygon(t,e=eg.Zero){return new i9({points:t,offset:e})}/**
     * Creates a new [[CircleCollider|circle]] collider
     *
     * Circle colliders are useful for balls, or to make collisions more forgiving on sharp edges
     * @param radius Radius of the circle collider
     * @param offset Optional offset relative to the collider in local coordinates
     */static Circle(t,e=eg.Zero){return new i2({radius:t,offset:e})}/**
...
let s=new iQ([i7.Circle(t/2,em(0,-e/2+t/2).add(i)),i7.Box(t,e-t,eg.Half,i),i7.Circle(t/2,em(0,e/2-t/2).add(i))]);return s}{// width > height, if equal maybe use a circle
let s=new iQ([i7.Circle(e/2,em(-t/2+e/2,0).add(i)),i7.Box(t-e,e,eg.Half,i),i7.Circle(e/2,em(t/2-e/2,0).add(i))]);return s}}}class i8 extends iO{constructor(t){super(),this.type="ex.collider",this.events=new tS,/**
     ...
     */clear(){this._collider&&(this._collider.events.unpipe(this.events),this.$colliderRemoved.notifyAll(this._collider),this._collider.owner=null,this._collider=null)}clone(){let t=new i8(this._collider.clone());return t}/**
...
this.events.on("precollision",e=>{t.events.emit("precollision",new tX(e.target.owner,e.other.owner,e.side,e.intersection))}),this.events.on("postcollision",e=>{t.events.emit("postcollision",new tZ(e.target.owner,e.other.owner,e.side,e.intersection))}),this.events.on("collisionstart",e=>{t.events.emit("collisionstart",new tQ(e.target.owner,e.other.owner,e.contact))}),this.events.on("collisionend",e=>{t.events.emit("collisionend",new tJ(e.target.owner,e.other.owner))})}onRemove(){this.events.clear(),this.$colliderRemoved.notifyAll(this._collider)}/**
     ...
     */useBoxCollider(t,e,i=eg.Half,s=eg.Zero){let r=i7.Box(t,e,i,s);return this.set(r)}/**
     ...
     *
     * By default, the box is center is at (0, 0) which means it is centered around the actors anchor.
     */usePolygonCollider(t,e=eg.Zero){let i=i7.Polygon(t,e);return this.set(i)}/**
     * Sets up a [[Circle|circle collision geometry]] as the only collider with a specified radius in pixels.
     *
     * By default, the box is center is at (0, 0) which means it is centered around the actors anchor.
     */useCircleCollider(t,e=eg.Zero){let i=i7.Circle(t,e);return this.set(i)}/**
     * Sets up an [[Edge|edge collision geometry]] with a start point and an end point relative to the anchor of the associated actor
     * of this physics body.
     *
     * By default, the box is center is at (0, 0) which means it is centered around the actors anchor.
     */useEdgeCollider(t,e){let i=i7.Edge(t,e);return this.set(i)}/**
     * Setups up a [[CompositeCollider]] which can define any arbitrary set of excalibur colliders
     * @param colliders
     */useCompositeCollider(t){return this.set(new iQ(t))}}(v=Q||(Q={})).Rotation="rotation",v.X="x",v.Y="y";/**
 * Body describes all the physical properties pos, vel, acc, rotation, angular velocity for the purpose of
 * of physics simulation.
 */class st extends iO{constructor(t){var e,i,s;super(),this.type="ex.body",this.dependencies=[iW,iV],this.id=tA("body",st._ID++),this.events=new tS,this._oldTransform=new iU,/**
...
let t=this.owner.get(i8);if(t){t.$colliderAdded.subscribe(()=>{this._cachedInertia=null}),t.$colliderRemoved.subscribe(()=>{this._cachedInertia=null});let e=t.get();if(e)return this._cachedInertia=e.getInertia(this.mass)}return 0}/**
...
this.__oldTransformCaptured=!0,this.transform.get().clone(this._oldTransform),this.oldVel.setTo(this.vel.x,this.vel.y),this.oldAcc.setTo(this.acc.x,this.acc.y)}clone(){let t=super.clone();return t}}st._ID=0;/**
 * AddedComponent message
 */class se{constructor(t){this.data=t,this.type="Component Added"}}/**
 * Type guard to know if message is f an Added Component
 */function si(t){return!!t&&"Component Added"===t.type}/**
 * RemovedComponent message
 */class ss{constructor(t){this.data=t,this.type="Component Removed"}}/**
 * Type guard to know if message is for a Removed Component
 */function sr(t){return!!t&&"Component Removed"===t.type}let sn={Initialize:"initialize",PreUpdate:"preupdate",PostUpdate:"postupdate"};/**
 ...
 */class so{constructor(t,e){if(/**
     ...
     */get types(){return this._typesMemo}_rebuildMemos(){this._tagsMemo=Array.from(this._componentStringToInstance.values()).filter(t=>t instanceof iN).map(t=>t.type),this._typesMemo=Array.from(this._componentStringToInstance.keys())}getComponents(){return Array.from(this._componentStringToInstance.values())}_notifyAddComponent(t){this._rebuildMemos();let e=new se({component:t,entity:this});this.componentAdded$.notifyAll(e)}_notifyRemoveComponent(t){let e=new ss({component:t,entity:this});this.componentRemoved$.notifyAll(e),this._rebuildMemos()}get parent(){return this._parent}/**
...
for(let t=this.children.length-1;t>=0;t--)this.removeChild(this.children[t]);return this}/**
     ...
     */clone(){let t=new so;for(let e of this.types)t.addComponent(this.get(e).clone());for(let e of this.children)t.addChild(e.clone());return t}/**
 ...
 */function sa(t){return!!t.tick}so._ID=0;class sh{constructor(t,e){this._options=t,this._graphics=e,this.graphics=[]}get name(){return this._options.name}hide(t){if(t){let e=null;e=t instanceof eM?t:this._graphics.getGraphic(t),this.graphics=this.graphics.filter(t=>t.graphic!==e),this._graphics.recalculateBounds()}else this.graphics.length=0}/**
     ...
     */get offset(){var t;return null!==(t=this._options.offset)&&void 0!==t?t:eg.Zero}set offset(t){this._options.offset=t}get currentKeys(){var t;return null!==(t=this.name)&&void 0!==t?t:"anonymous"}clone(t){let e=new sh({...this._options},t);return e.graphics=[...this.graphics.map(t=>({graphic:t.graphic.clone(),options:{...t.options}}))],e}}class sl{constructor(t){this._component=t,this._layers=[],this._layerMap={},this.default=new sh({name:"default",order:0},t),this._maybeAddLayer(this.default)}create(t){let e=new sh(t,this._component);return this._maybeAddLayer(e)}get(t){return t?this._getLayer(t):this._layers}currentKeys(){let t=[];for(let e of this._layers)t.push(e.currentKeys);return t}has(t){return t in this._layerMap}_maybeAddLayer(t){return this._layerMap[t.name]?this._layerMap[t.name]:(this._layerMap[t.name]=t,this._layers.push(t),this._layers.sort((t,e)=>t.order-e.order),t)}_getLayer(t){return this._layerMap[t]}clone(t){let e=new sl(t);e._layerMap={},e._layers=[],e.default=this.default.clone(t),e._maybeAddLayer(e.default);// Remove the default layer out of the clone
let i=this._layers.filter(t=>"default"!==t.name).map(e=>e.clone(t));return i.forEach(t=>e._maybeAddLayer(t)),e}}/**
 * Component to manage drawings, using with the position component
 */class sd extends iO{getGraphic(t){return this._graphics[t]}/**
...
t={visible:this.visible,...t};let{current:e,anchor:i,opacity:s,visible:r,graphics:n,offset:o,copyGraphics:a,onPreDraw:h,onPostDraw:l}=t;this._graphics=n||{},this.offset=null!=o?o:this.offset,this.opacity=null!=s?s:this.opacity,this.anchor=null!=i?i:this.anchor,this.copyGraphics=null!=a?a:this.copyGraphics,this.onPreDraw=null!=h?h:this.onPreDraw,this.onPostDraw=null!=l?l:this.onPostDraw,this.visible=!!r,this.layers=new sl(this),e&&this._graphics[e]&&this.show(this._graphics[e])}/**
     ...
     * @param elapsed
     * @internal
     */update(t,e=0){for(let i of this.layers.get())for(let{graphic:s}of i.graphics)sa(s)&&(null==s||s.tick(t,e))}clone(){let t=new sd;return t._graphics={...this._graphics},t.offset=this.offset.clone(),t.opacity=this.opacity,t.anchor=this.anchor.clone(),t.copyGraphics=this.copyGraphics,t.onPreDraw=this.onPreDraw,t.onPostDraw=this.onPostDraw,t.visible=this.visible,t.layers=this.layers.clone(t),t}}/**
 * A Rectangle [[Graphic]] for drawing rectangles to the [[ExcaliburGraphicsContext]]
 */class sc extends ig{constructor(t){super(t),this.width=t.width,this.height=t.height,this.rasterize()}clone(){return new sc({width:this.width,height:this.height,...this.cloneGraphicOptions(),...this.cloneRasterOptions()})}execute(t){this.color&&t.fillRect(0,0,this.width,this.height),this.strokeColor&&t.strokeRect(0,0,this.width,this.height)}}/**
 * A circle [[Graphic]] for drawing circles to the [[ExcaliburGraphicsContext]]
 *
 * Circles default to [[ImageFiltering.Blended]]
 */class su extends ig{get radius(){return this._radius}set radius(t){this._radius=t,this.width=2*this._radius,this.height=2*this._radius,this.flagDirty()}constructor(t){var e,i,s;super(t),this._radius=0;let r=null!==(e=t.lineWidth)&&void 0!==e?e:t.strokeColor?1:0;// default lineWidth in canvas is 1px
this.padding=null!==(i=t.padding)&&void 0!==i?i:2+r/2,this.radius=t.radius,this.filtering=null!==(s=t.filtering)&&void 0!==s?s:q.Blended,this.rasterize()}clone(){return new su({radius:this.radius,...this.cloneGraphicOptions(),...this.cloneRasterOptions()})}execute(t){this.radius>0&&(t.beginPath(),t.arc(this.radius,this.radius,this.radius,0,2*Math.PI),this.color&&t.fill(),this.strokeColor&&t.stroke())}}/**
 ...
 */class sp extends iO{constructor(){super(...arguments),this.type="ex.pointer",/**
 ...
 * }
 * ```
 */class s_{static CreateReversibleEasingFunction(t){return(e,i,s,r)=>s<i?i-(t(e,s,i,r)-s):t(e,i,s,r)}static CreateVectorEasingFunction(t){return(e,i,s,r)=>new eg(t(e,i.x,s.x,r),t(e,i.y,s.y,r))}}s_.Linear=s_.CreateReversibleEasingFunction((t,e,i,s)=>(i-=e)*t/s+e),s_.EaseInQuad=s_.CreateReversibleEasingFunction((t,e,i,s)=>(i-=e)*(t/=s)*t+e),s_.EaseOutQuad=s_.CreateReversibleEasingFunction((t,e,i,s)=>-(i-=e)*(t/=s)*(t-2)+e),s_.EaseInOutQuad=s_.CreateReversibleEasingFunction((t,e,i,s)=>(i-=e,(t/=s/2)<1)?i/2*t*t+e:-i/2*(--t*(t-2)-1)+e),s_.EaseInCubic=s_.CreateReversibleEasingFunction((t,e,i,s)=>(i-=e)*(t/=s)*t*t+e),s_.EaseOutCubic=s_.CreateReversibleEasingFunction((t,e,i,s)=>(i-=e,t/=s,i*(--t*t*t+1)+e)),s_.EaseInOutCubic=s_.CreateReversibleEasingFunction((t,e,i,s)=>(i-=e,(t/=s/2)<1)?i/2*t*t*t+e:i/2*((t-=2)*t*t+2)+e);/**
...
this._motion.vel=em((e-this._tx.pos.x)/(t/1e3),(i-this._tx.pos.y)/(t/1e3))):(this._tx.pos=em(this._lerpEnd.x,this._lerpEnd.y),this._motion.vel=eg.Zero)}isComplete(){return this._stopped||this._currentLerpTime>=this._lerpDuration}reset(){this._initialized=!1,this._stopped=!1,this._currentLerpTime=0}stop(){this._motion.vel=em(0,0),this._stopped=!0}}class sT{constructor(t,e,i,s,r){this.easingFcn=r,this._currentLerpTime=0,this._lerpDuration=1e3,this._lerpStart=new eg(0,0),this._lerpEnd=new eg(0,0),this._initialized=!1,this._stopped=!1,this._tx=t.get(iW),this._motion=t.get(iV),this._lerpDuration=s,this._offset=new eg(e,i)}_initialize(){this._lerpStart=new eg(this._tx.pos.x,this._tx.pos.y),this._currentLerpTime=0,this._lerpEnd=this._lerpStart.add(this._offset)}update(t){this._initialized||(this._initialize(),this._initialized=!0),// Need to update lerp time first, otherwise the first update will always be zero
this._currentLerpTime+=t;let e=this._tx.pos.x,i=this._tx.pos.y;this._currentLerpTime<this._lerpDuration?(e=this._lerpEnd.x<this._lerpStart.x?this._lerpStart.x-(this.easingFcn(this._currentLerpTime,this._lerpEnd.x,this._lerpStart.x,this._lerpDuration)-this._lerpEnd.x):this.easingFcn(this._currentLerpTime,this._lerpStart.x,this._lerpEnd.x,this._lerpDuration),i=this._lerpEnd.y<this._lerpStart.y?this._lerpStart.y-(this.easingFcn(this._currentLerpTime,this._lerpEnd.y,this._lerpStart.y,this._lerpDuration)-this._lerpEnd.y):this.easingFcn(this._currentLerpTime,this._lerpStart.y,this._lerpEnd.y,this._lerpDuration),// Given the lerp position figure out the velocity in pixels per second
this._motion.vel=em((e-this._tx.pos.x)/(t/1e3),(i-this._tx.pos.y)/(t/1e3))):(this._tx.pos=em(this._lerpEnd.x,this._lerpEnd.y),this._motion.vel=eg.Zero)}isComplete(){return this._stopped||this._currentLerpTime>=this._lerpDuration}reset(){this._initialized=!1,this._stopped=!1,this._currentLerpTime=0}stop(){this._motion.vel=em(0,0),this._stopped=!0}}class sE{constructor(t,e,i,s=1){this._timeVisible=0,this._timeNotVisible=0,this._elapsedTime=0,this._totalTime=0,this._stopped=!1,this._started=!1,this._graphics=t.get(sd),this._timeVisible=e,this._timeNotVisible=i,this._duration=(e+i)*s}update(t){this._started||(this._started=!0,this._elapsedTime=0,this._totalTime=0),this._graphics&&(this._elapsedTime+=t,this._totalTime+=t,this._graphics.visible&&this._elapsedTime>=this._timeVisible&&(this._graphics.visible=!1,this._elapsedTime=0),!this._graphics.visible&&this._elapsedTime>=this._timeNotVisible&&(this._graphics.visible=!0,this._elapsedTime=0),this.isComplete()&&(this._graphics.visible=!0))}isComplete(){return this._stopped||this._totalTime>=this._duration}stop(){this._graphics&&(this._graphics.visible=!0),this._stopped=!0}reset(){this._started=!1,this._stopped=!1,this._elapsedTime=0,this._totalTime=0}}class sP{constructor(t,e,i){this._multiplier=1,this._started=!1,this._stopped=!1,this._graphics=t.get(sd),this._endOpacity=e,this._speed=this._ogspeed=i}update(t){this._graphics&&(this._started||(this._started=!0,this._speed=this._ogspeed,this._endOpacity<this._graphics.opacity?this._multiplier=-1:this._multiplier=1),this._speed>0&&(this._graphics.opacity+=this._multiplier*(Math.abs(this._graphics.opacity-this._endOpacity)*t)/this._speed),this._speed-=t,this.isComplete()&&(this._graphics.opacity=this._endOpacity),t7.getInstance().debug("[Action fade] Actor opacity:",this._graphics.opacity))}isComplete(){return this._stopped||.05>Math.abs(this._graphics.opacity-this._endOpacity)}stop(){this._stopped=!0}reset(){this._started=!1,this._stopped=!1}}class sI{constructor(t){this._elapsedTime=0,this._started=!1,this._stopped=!1,this._delay=t}update(t){this._started||(this._started=!0),this._elapsedTime+=t}isComplete(){return this._stopped||this._elapsedTime>=this._delay}stop(){this._stopped=!0}reset(){this._elapsedTime=0,this._started=!1,this._stopped=!1}}class sD{constructor(t){this._stopped=!1,this._entity=t}update(t){this._entity.get(sk).clearActions(),this._entity.kill(),this._stopped=!0}isComplete(){return this._stopped}stop(){}reset(){}}class sB{constructor(t,e,i){this._started=!1,this._stopped=!1,this._tx=t.get(iW),this._motion=t.get(iV),this._followTx=e.get(iW),this._followMotion=e.get(iV),this._current=new eg(this._tx.pos.x,this._tx.pos.y),this._end=new eg(this._followTx.pos.x,this._followTx.pos.y),this._maximumDistance=void 0!==i?i:this._current.distance(this._end),this._speed=0}update(t){this._started||(this._started=!0,this._distanceBetween=this._current.distance(this._end),this._dir=this._end.sub(this._current).normalize());let e=Math.sqrt(Math.pow(this._followMotion.vel.x,2)+Math.pow(this._followMotion.vel.y,2));if(0!==e&&(this._speed=e),this._current=em(this._tx.pos.x,this._tx.pos.y),this._end=em(this._followTx.pos.x,this._followTx.pos.y),this._distanceBetween=this._current.distance(this._end),this._dir=this._end.sub(this._current).normalize(),this._distanceBetween>=this._maximumDistance){let t=this._dir.scale(this._speed);this._motion.vel=em(t.x,t.y)}else this._motion.vel=em(0,0);this.isComplete()&&(this._tx.pos=em(this._end.x,this._end.y),this._motion.vel=em(0,0))}stop(){this._motion.vel=em(0,0),this._stopped=!0}isComplete(){// the actor following should never stop unless specified to do so
return this._stopped}reset(){this._started=!1,this._stopped=!1}}class sF{constructor(t,e,i){this._started=!1,this._stopped=!1,this._speedWasSpecified=!1,this._tx=t.get(iW),this._motion=t.get(iV),this._meetTx=e.get(iW),this._meetMotion=e.get(iV),this._current=new eg(this._tx.pos.x,this._tx.pos.y),this._end=new eg(this._meetTx.pos.x,this._meetTx.pos.y),this._speed=i||0,void 0!==i&&(this._speedWasSpecified=!0)}update(t){this._started||(this._started=!0,this._distanceBetween=this._current.distance(this._end),this._dir=this._end.sub(this._current).normalize());let e=Math.sqrt(Math.pow(this._meetMotion.vel.x,2)+Math.pow(this._meetMotion.vel.y,2));0===e||this._speedWasSpecified||(this._speed=e),this._current=em(this._tx.pos.x,this._tx.pos.y),this._end=em(this._meetTx.pos.x,this._meetTx.pos.y),this._distanceBetween=this._current.distance(this._end),this._dir=this._end.sub(this._current).normalize();let i=this._dir.scale(this._speed);this._motion.vel=em(i.x,i.y),this.isComplete()&&(this._tx.pos=em(this._end.x,this._end.y),this._motion.vel=em(0,0))}isComplete(){return this._stopped||this._distanceBetween<=1}stop(){this._motion.vel=em(0,0),this._stopped=!0}reset(){this._started=!1,this._stopped=!1,this._distanceBetween=void 0}}/**
 * The fluent Action API allows you to perform "actions" on
 * [[Actor|Actors]] such as following, moving, rotating, and
 * more. You can implement your own actions by implementing
 * the [[Action]] interface.
 */class sR{constructor(t){this._entity=t,this._queue=new sg(t)}getQueue(){return this._queue}update(t){this._queue.update(t)}/**
     * Clears all queued actions from the Actor
     */clearActions(){this._queue.clearActions()}runAction(t){return t.reset(),this._queue.add(t),this}easeTo(...t){var e,i;let s=0,r=0,n=0,o=s_.Linear;return t[0]instanceof eg?(s=t[0].x,r=t[0].y,n=t[1],o=null!==(e=t[2])&&void 0!==e?e:o):(s=t[0],r=t[1],n=t[2],o=null!==(i=t[3])&&void 0!==i?i:o),this._queue.add(new sS(this._entity,s,r,n,o)),this}easeBy(...t){var e,i;let s=0,r=0,n=0,o=s_.Linear;return t[0]instanceof eg?(s=t[0].x,r=t[0].y,n=t[1],o=null!==(e=t[2])&&void 0!==e?e:o):(s=t[0],r=t[1],n=t[2],o=null!==(i=t[3])&&void 0!==i?i:o),this._queue.add(new sT(this._entity,s,r,n,o)),this}moveTo(t,e,i){let s=0,r=0,n=0;return t instanceof eg?(s=t.x,r=t.y,n=e):(s=t,r=e,n=i),this._queue.add(new sx(this._entity,s,r,n)),this}moveBy(t,e,i){let s=0,r=0,n=0;return t instanceof eg?(s=t.x,r=t.y,n=e):(s=t,r=e,n=i),this._queue.add(new sv(this._entity,s,r,n)),this}/**
     ...
     */rotateBy(t,e,i){return this._queue.add(new sw(this._entity,t,e,i)),this}scaleTo(t,e,i,s){let r=1,n=1,o=0,a=0;return t instanceof eg&&e instanceof eg&&(r=t.x,n=t.y,o=e.x,a=e.y),"number"==typeof t&&"number"==typeof e&&(r=t,n=e,o=i,a=s),this._queue.add(new sb(this._entity,r,n,o,a)),this}scaleBy(t,e,i){let s=1,r=1;return t instanceof eg&&(s=t.x,r=t.y,i=e),"number"==typeof t&&"number"==typeof e&&(s=t,r=e),this._queue.add(new sC(this._entity,s,r,i)),this}/**
     ...
     */blink(t,e,i=1){return this._queue.add(new sE(this._entity,t,e,i)),this}/**
     * This method will cause an actor's opacity to change from its current value
     * to the provided value by a specified time (in milliseconds). This method is
     * part of the actor 'Action' fluent API allowing action chaining.
     * @param opacity  The ending opacity
     * @param time     The time it should take to fade the actor (in milliseconds)
     */fade(t,e){return this._queue.add(new sP(this._entity,t,e)),this}/**
     * This method will delay the next action from executing for a certain
     * amount of time (in milliseconds). This method is part of the actor
     * 'Action' fluent API allowing action chaining.
     * @param time  The amount of time to delay the next action in the queue from executing in milliseconds
     */delay(t){return this._queue.add(new sI(t)),this}/**
     ...
     */callMethod(t){return this._queue.add(new sA(t)),this}/**
     ...
     * will repeat forever
     */repeat(t,e){return e?this._queue.add(new sm(this._entity,t,e)):this.repeatForever(t),this}/**
     * This method will cause the actor to repeat all of the actions built in
     * the `repeatBuilder` callback. If the number of repeats
     * is not specified it will repeat forever. This method is part of
     * the actor 'Action' fluent API allowing action chaining
     ...
     * ```
     * @param repeatBuilder The builder to specify the repeatable list of actions
     */repeatForever(t){return this._queue.add(new sf(this._entity,t)),this}/**
     * This method will cause the entity to follow another at a specified distance
     * @param entity           The entity to follow
     * @param followDistance  The distance to maintain when following, if not specified the actor will follow at the current distance.
     */follow(t,e){return void 0===e?this._queue.add(new sB(this._entity,t)):this._queue.add(new sB(this._entity,t,e)),this}/**
     * This method will cause the entity to move towards another until they
     * collide "meet" at a specified speed.
     * @param entity  The entity to meet
     * @param speed  The speed in pixels per second to move, if not specified it will match the speed of the other actor
     */meet(t,e){return void 0===e?this._queue.add(new sF(this._entity,t)):this._queue.add(new sF(this._entity,t,e)),this}/**
     * Returns a promise that resolves when the current action queue up to now
     * is finished.
     */toPromise(){let t=new Promise(t=>{this._queue.add(new sA(()=>{t()}))});return t}}class sk extends iO{constructor(){super(...arguments),this.type="ex.actions",this.dependencies=[iW,iV]}onAdd(t){this._ctx=new sR(t)}onRemove(){this._ctx=null}/**
...
i[t]=s,i[t+1]=r}}return this._chachedText=t,this._chachedLines=i,this._cachedRenderWidth=e,i}}class sL{static measureText(t,e,i){let s=sM.getHashCode(e,t);if(sL._MEASURE_CACHE.has(s))return sL._MEASURE_CACHE.get(s);sL._LOGGER.debug("Font text measurement cache miss");let r=e.measureTextWithoutCache(t,i);return sL._MEASURE_CACHE.set(s,r),r}static getTextInstance(t,e,i){let s=sM.getHashCode(e,t,i),r=sL._TEXT_CACHE.get(s);return r||(r=new sM(e,t,i),sL._TEXT_CACHE.set(s,r),sL._LOGGER.debug("Font text instance cache miss")),// Cache the bitmap for certain amount of time
...
let i=new Map;for(let t of e)sL._MEASURE_CACHE.has(t)&&i.set(t,sL._MEASURE_CACHE.get(t));this._MEASURE_CACHE.clear(),this._MEASURE_CACHE=i}static get cacheSize(){return sL._TEXT_USAGE.size}/**
     ...
     */static clearCache(){for(let[t]of sL._TEXT_USAGE.entries())t.dispose();sL._TEXT_USAGE.clear(),sL._TEXT_CACHE.clear(),sL._MEASURE_CACHE.clear()}}sL._LOGGER=t7.getInstance(),sL._TEXT_USAGE=new Map,sL._TEXT_CACHE=new Map,sL._MEASURE_CACHE=new Map;/**
 * Represents a system or web font in Excalibur
 *
 * If no options specified, the system sans-serif 10 pixel is used
 *
 * If loading a custom web font be sure to have the font loaded before you use it https://erikonarheim.com/posts/dont-test-fonts/
 */class sz extends eM{constructor(t={}){var e,i,s,r,n,o,a,h,l,d,c,u,p,_,g,m,f,v,x;super(t),/**
...
/**
     ...
     */constructor(t){super(),this.events=new tS,/**
         ...
         * Draggable helper
         */this._draggable=!1,this._dragging=!1,this._pointerDragStartHandler=()=>{this._dragging=!0},this._pointerDragEndHandler=()=>{this._dragging=!1},this._pointerDragMoveHandler=t=>{this._dragging&&(this.pos=t.worldPos)},this._pointerDragLeaveHandler=t=>{this._dragging&&(this.pos=t.worldPos)};let{name:e,x:i,y:s,pos:r,coordPlane:n,scale:o,width:a,height:h,radius:l,collider:d,vel:c,acc:u,rotation:p,angularVelocity:_,z:g,color:m,visible:f,anchor:v,collisionType:x,collisionGroup:y}={...t};this._setName(e),this.anchor=null!=v?v:sU.defaults.anchor.clone();let w=new iW;this.addComponent(w),this.pos=null!=r?r:em(null!=i?i:0,null!=s?s:0),this.rotation=null!=p?p:0,this.scale=null!=o?o:em(1,1),this.z=null!=g?g:0,w.coordPlane=null!=n?n:$.World,this.addComponent(new sp),this.addComponent(new sd({anchor:this.anchor})),this.addComponent(new iV),this.vel=null!=c?c:eg.Zero,this.acc=null!=u?u:eg.Zero,this.angularVelocity=null!=_?_:0,this.addComponent(new sk),this.addComponent(new st),this.body.collisionType=null!=x?x:Z.Passive,y&&(this.body.group=y),d?this.addComponent(new i8(d)):l?this.addComponent(new i8(i7.Circle(l))):a>0&&h>0?this.addComponent(new i8(i7.Box(a,h,this.anchor))):this.addComponent(new i8),this.graphics.visible=null==f||f,m&&(this.color=m,a&&h?this.graphics.add(new sc({color:m,width:a,height:h})):l&&this.graphics.add(new su({color:m,radius:l})))}clone(){let t=new sU({color:this.color.clone(),anchor:this.anchor.clone()});t.clearComponents(),t.processComponentRemoval();// Clone the current actors components
...
/**
     ...
     */contains(t,e,i=!1){let s=em(t,e),r=this.get(i8);r.update();let n=r.get();if(!n)return!1;let o=n.contains(s);return i?o||this.children.some(i=>i.contains(t,e,!0)):o}/**
     * Returns true if the two actor.collider's surfaces are less than or equal to the distance specified from each other
     * @param actor     Actor to test
     * @param distance  Distance in pixels to test
     */within(t,e){let i=this.get(i8),s=t.get(i8),r=i.get(),n=s.get();return!!r&&!!n&&r.getClosestLineBetween(n).getLength()<=e}// #endregion
// #region Update
/**
 ...
 */function sO(t){return t instanceof sN}// #region Properties
/**
 * Set defaults for all Actors
 */sU.defaults={anchor:eg.Half};/**
 * Helper [[Actor]] primitive for drawing UI's, optimized for UI drawing. Does
 * not participate in collisions. Drawn on top of all other actors.
 */class sN extends sU{constructor(t){var e,i;super({...t}),this.get(iW).coordPlane=$.Screen,this.anchor=null!==(e=null==t?void 0:t.anchor)&&void 0!==e?e:em(0,0),this.body.collisionType=null!==(i=null==t?void 0:t.collisionType)&&void 0!==i?i:Z.PreventCollision,this.pointer.useGraphicsBounds=!0,this.pointer.useColliderShape=!1,!(null==t?void 0:t.collider)&&(null==t?void 0:t.width)>0&&(null==t?void 0:t.height)>0&&this.collider.useBoxCollider(this.width,this.height,this.anchor)}_initialize(t){this._engine=t,super._initialize(t)}contains(t,e,i=!0){if(i)return super.contains(t,e);let s=this._engine.worldToScreenCoordinates(new eg(t,e));return super.contains(s.x,s.y)}}/**
 * The Excalibur timer hooks into the internal timer and fires callbacks,
 * after a certain interval, optionally repeating.
 */class sH{get complete(){return this._complete}constructor(t,e,i,s,r,n){if(this._logger=t7.getInstance(),this.id=0,this._elapsedTime=0,this._totalTimeAlive=0,this._running=!1,this._numberOfTicks=0,this.interval=10,this.repeats=!1,this.maxNumberOfRepeats=-1,this.randomRange=[0,0],this._baseInterval=10,this._generateRandomInterval=()=>this._baseInterval+this.random.integer(this.randomRange[0],this.randomRange[1]),this._complete=!1,this.scene=null,"function"!=typeof t){let o=t;t=o.fcn,e=o.interval,i=o.repeats,s=o.numberOfRepeats,r=o.randomRange,n=o.random}if(s&&s>=0&&(this.maxNumberOfRepeats=s,!i))throw Error("repeats must be set to true if numberOfRepeats is set");if(this.id=sH._MAX_ID++,this._callbacks=[],this._baseInterval=this.interval=e,r){if(r[0]>r[1])throw Error("min value must be lower than max value for range");//We use the instance of ex.Random to generate the range
this.random=null!=n?n:new er,this.randomRange=r,this.interval=this._generateRandomInterval(),this.on(()=>{this.interval=this._generateRandomInterval()})}this.repeats=i||this.repeats,t&&this.on(t)}/**
     ...
     */cancel(){this.pause(),this.scene&&this.scene.cancelTimer(this)}}sH._MAX_ID=0;class sW extends iO{constructor(t){super(),this.type="ex.parallax",this.parallaxFactor=em(1,1),this.parallaxFactor=null!=t?t:this.parallaxFactor}}/**
 ...
 *
 */class sV extends iO{constructor(t,e=!0){super(),this.draw=t,this.useTransform=e,this.type="ex.debuggraphics"}}/**
 * QuadTree spatial data structure. Useful for quickly retrieving all objects that might
 * be in a specific location.
 */class sG{constructor(t,e){this.bounds=t,this.options=e,this._defaultOptions={maxDepth:10,capacity:10,level:0},this.items=[],this._isDivided=!1,this.topLeft=null,this.topRight=null,this.bottomLeft=null,this.bottomRight=null,this.options={...this._defaultOptions,...e},this.halfWidth=t.width/2,this.halfHeight=t.height/2}/**
     * Splits the quad tree one level deeper
     */_split(){this._isDivided=!0;let t={maxDepth:this.options.maxDepth,capacity:this.options.capacity,level:this.options.level+1};this.topLeft=new sG(new ex({left:this.bounds.left,top:this.bounds.top,right:this.bounds.left+this.halfWidth,bottom:this.bounds.top+this.halfHeight}),t),this.topRight=new sG(new ex({left:this.bounds.left+this.halfWidth,top:this.bounds.top,right:this.bounds.right,bottom:this.bounds.top+this.halfHeight}),t),this.bottomLeft=new sG(new ex({left:this.bounds.left,top:this.bounds.top+this.halfHeight,right:this.bounds.left+this.halfWidth,bottom:this.bounds.bottom}),t),this.bottomRight=new sG(new ex({left:this.bounds.left+this.halfWidth,top:this.bounds.top+this.halfHeight,right:this.bounds.right,bottom:this.bounds.bottom}),t)}_insertIntoSubNodes(t){var e,i,s,r;(null===(e=this.topLeft)||void 0===e?void 0:e.bounds.overlaps(t.bounds))&&this.topLeft.insert(t),(null===(i=this.topRight)||void 0===i?void 0:i.bounds.overlaps(t.bounds))&&this.topRight.insert(t),(null===(s=this.bottomLeft)||void 0===s?void 0:s.bounds.overlaps(t.bounds))&&this.bottomLeft.insert(t),(null===(r=this.bottomRight)||void 0===r?void 0:r.bounds.overlaps(t.bounds))&&this.bottomRight.insert(t)}/**
 ...
 */class sX extends so{flagCollidersDirty(){this._collidersDirty=!0}flagTilesDirty(){for(let t=0;t<this.tiles.length;t++)this.tiles[t]&&this.tiles[t].flagDirty()}get x(){var t;return null!==(t=this._transform.pos.x)&&void 0!==t?t:0}set x(t){var e;(null===(e=this._transform)||void 0===e?void 0:e.pos)&&(this.get(iW).pos=em(t,this.y))}get y(){var t,e;return null!==(e=null===(t=this._transform)||void 0===t?void 0:t.pos.y)&&void 0!==e?e:0}set y(t){var e;(null===(e=this._transform)||void 0===e?void 0:e.pos)&&(this._transform.pos=em(this.x,t))}get z(){var t;return null!==(t=this._transform.z)&&void 0!==t?t:0}set z(t){this._transform&&(this._transform.z=t)}get rotation(){var t,e;return null!==(e=null===(t=this._transform)||void 0===t?void 0:t.rotation)&&void 0!==e?e:0}set rotation(t){this._transform&&(this._transform.rotation=t)}get scale(){var t,e;return null!==(e=null===(t=this._transform)||void 0===t?void 0:t.scale)&&void 0!==e?e:eg.One}set scale(t){var e;(null===(e=this._transform)||void 0===e?void 0:e.scale)&&(this._transform.scale=t)}get pos(){return this._transform.pos}set pos(t){this._transform.pos=t}get vel(){return this._motion.vel}set vel(t){this._motion.vel=t}emit(t,e){this.events.emit(t,e)}on(t,e){return this.events.on(t,e)}once(t,e){return this.events.once(t,e)}off(t,e){this.events.off(t,e)}/**
     * @param options
     */constructor(t){var e,i;super(null,t.name),this.events=new tS,this._token=0,this.logger=t7.getInstance(),this.tiles=[],this._rows=[],this._cols=[],this.renderFromTopOfGraphic=!1,this._collidersDirty=!0,this._originalOffsets=new WeakMap,this.addComponent(new iW),this.addComponent(new iV),this.addComponent(new st({type:Z.Fixed})),this.addComponent(new sd({onPostDraw:(t,e)=>this.draw(t,e)})),this.addComponent(new sV(t=>this.debug(t),!1)),this.addComponent(new i8),this._graphics=this.get(sd),this._transform=this.get(iW),this._motion=this.get(iV),this._collider=this.get(i8),this._composite=this._collider.useCompositeCollider([]),this._transform.pos=null!==(e=t.pos)&&void 0!==e?e:eg.Zero,this._oldPos=this._transform.pos.clone(),this._oldScale=this._transform.scale.clone(),this.renderFromTopOfGraphic=null!==(i=t.renderFromTopOfGraphic)&&void 0!==i?i:this.renderFromTopOfGraphic,this.tileWidth=t.tileWidth,this.tileHeight=t.tileHeight,this.rows=t.rows,this.columns=t.columns,// TODO we need to invalidate the quad tree if the tilemap ever moves
this._quadTree=new sG(ex.fromDimension(this.columns*this.tileWidth,this.rows*this.tileHeight,eg.Zero,this.pos)),this.tiles=Array(this.rows*this.columns),this._rows=Array(this.rows),this._cols=Array(this.columns);let s=[];for(let t=0;t<this.columns;t++){for(let e=0;e<this.rows;e++){let i=new sZ({x:t,y:e,map:this});i.map=this,this._quadTree.insert(i),this.tiles[t+e*this.columns]=i,s.push(i),this._rows[e]||(this._rows[e]=[]),this._rows[e].push(i)}this._cols[t]=s,s=[]}this._graphics.localBounds=new ex({left:0,top:0,right:this.columns*this.tileWidth*this.scale.x,bottom:this.rows*this.tileHeight*this.scale.y})}_initialize(t){super._initialize(t),this._engine=t}_getOrSetColliderOriginalOffset(t){if(this._originalOffsets.has(t))return this._originalOffsets.get(t);{let e=t.offset;return this._originalOffsets.set(t,e),e}}_updateQuadTree(){this._quadTree=new sG(ex.fromDimension(this.columns*this.tileWidth,this.rows*this.tileHeight,eg.Zero,eg.Zero).scale(this.scale).translate(this.pos).rotate(this.rotation,this.pos));for(let t=0;t<this.tiles.length;t++)this._quadTree.insert(this.tiles[t])}/**
...
let i=e[e.length-1];i&&i.top===t.top&&i.bottom===t.bottom?e[e.length-1]=i.combine(t):e.push(t)}}for(let t of e){let e=i7.Box(t.width,t.height,eg.Zero,em(t.left-this.pos.x,t.top-this.pos.y));e.owner=this,this._composite.addCollider(e)}this._collider.update(),// Notify that colliders have been updated
...
let n=this._engine.screen.getWorldBounds(),o=this._engine.screen.getScreenBounds(),a=this._transform.coordPlane===$.Screen,h=this.get(sW);if(h){let t=this.pos,e=eg.One.sub(h.parallaxFactor),i=this._engine.currentScene.camera.pos.scale(e);t=t.sub(i),// adjust world bounds by parallax factor
 ...
 */class sZ extends so{// private _transform: TransformComponent;
/**
 ...
 * @internal
 */class sK{constructor(t){this.camera=t}/**
     * Creates and adds the [[LockCameraToActorStrategy]] on the current camera.
     * @param actor The actor to lock the camera to
     */lockToActor(t){this.camera.addStrategy(new sY(t))}/**
     ...
     */elasticToActor(t,e,i){this.camera.addStrategy(new s$(t,e,i))}/**
     * Creates and adds the [[RadiusAroundActorStrategy]] on the current camera
     * @param actor Target actor to follow when it is "radius" pixels away
     * @param radius Number of pixels away before the camera will follow
     */radiusAroundActor(t,e){this.camera.addStrategy(new sQ(t,e))}/**
     * Creates and adds the [[LimitCameraBoundsStrategy]] on the current camera
     * @param box The bounding box to limit the camera to.
     */limitCameraBounds(t){this.camera.addStrategy(new sJ(t))}}(S=tn||(tn={}))[S.X=0]="X",S[S.Y=1]="Y";/**
 * Lock a camera to the exact x/y position of an actor.
 */class sY{constructor(t){this.target=t,this.action=(t,e,i,s)=>{let r=t.center;return r}}}/**
 * Lock a camera to a specific axis around an actor.
 */class sj{constructor(t,e){this.target=t,this.axis=e,this.action=(t,e,i,s)=>{let r=t.center,n=e.getFocus();return this.axis===tn.X?new eg(r.x,n.y):new eg(n.x,r.y)}}}/**
 ...
 *
 */class s1{constructor(){this.events=new tS,this.transform=eP.identity(),this.inverse=eP.identity(),this._cameraStrategies=[],this.strategy=new sK(this),/**
...
this.transform.translate(t/2,e/2),this.transform.rotate(this.rotation),this.transform.translate(-t/2,-e/2),this.transform.translate(i.x,i.y),this.transform.inverse(this.inverse)}_isDoneShaking(){return!this._isShaking||this._elapsedShakeTime>=this._shakeDuration}}let s2={ExitTrigger:"exit",EnterTrigger:"enter"},s5={pos:eg.Zero,width:10,height:10,visible:!1,action:()=>{},filter:()=>!0,repeat:-1};/**
 ...
 * @param x
 */function s9(t){return!!t&&"Entity Added"===t.type}/**
 * An [[Entity]] with [[Component]] types that no longer matches a [[System]] types exists in the current scene.
 */class s7{constructor(t){this.data=t,this.type="Entity Removed"}}/**
...
class rt{constructor(t){this._world=t,this.entities=[],this._entityIndex={},this._entitiesToRemove=[]}/**
...
i.update(t.engine,e),i.active||this.removeEntity(i)}findEntitiesForRemoval(){for(let t of this.entities)t.active||this.removeEntity(t)}/**
     ...
     * @param message
     */notify(t){si(t)&&this._world.queryManager.addEntity(t.data.entity),sr(t)&&this._world.queryManager.removeComponent(t.data.entity,t.data.component)}/**
 ...
 * ```
 */class ri extends iH{get key(){return this._key?this._key:this._key=re(this.types)}constructor(t){super(),this._entities=[],t[0]instanceof Function?this.types=t.map(t=>(new t).type):this.types=t}/**
     * Returns a list of entities that match the query
     * @param sort Optional sorting function to sort entities returned from the query
     */getEntities(t){return t&&this._entities.sort(t),this._entities}/**
     * Add an entity to the query, will only be added if the entity matches the query types
     * @param entity
     */addEntity(t){!eA(this._entities,t)&&this.matches(t)&&(this._entities.push(t),this.notifyAll(new s6(t)))}/**
     * If the entity is part of the query it will be removed regardless of types
     * @param entity
     */removeEntity(t){eC(t,this._entities)&&this.notifyAll(new s7(t))}/**
     * Removes all entities and observers from the query
     */clear(){this._entities.length=0;for(let t=this.observers.length-1;t>=0;t--)this.unregister(this.observers[t])}matches(t){let e=[];e=t instanceof so?t.types:t;let i=!0;for(let t of this.types)if(!(i=i&&e.indexOf(t)>-1))return!1;return i}contain(t){return this.types.indexOf(t)>-1}}/**
 * The query manager is responsible for updating all queries when entities/components change
 */class rs{constructor(t){this._world=t,this._queries={}}/**
     * Adds a query to the manager and populates with any entities that match
     * @param query
     */_addQuery(t){for(let e of(this._queries[re(t.types)]=t,this._world.entityManager.entities))t.addEntity(e)}/**
     * Removes the query if there are no observers left
     * @param query
     */maybeRemoveQuery(t){0===t.observers.length&&(t.clear(),delete this._queries[re(t.types)])}/**
...
this._queries[i].contain(e.type)&&this._queries[i].removeEntity(t)}/**
     ...
     * @param types
     */createQuery(t){let e=this.getQuery(t);if(e)return e;let i=new ri(t);return this._addQuery(i),i}/**
     * Retrieves an existing query by types if it exists otherwise returns null
     * @param types
     */getQuery(t){let e=re(t);return this._queries[e]?this._queries[e]:null}}/**
 * The SystemManager is responsible for keeping track of all systems in a scene.
 * Systems are scene specific
 */class rr{constructor(t){this._world=t,/**
...
if(e instanceof rE)for(let t of s)t._initialize(null==e?void 0:e.engine);t.update(s,i)}for(let t of s)t.postupdate&&t.postupdate(e,i)}clear(){for(let t=this.systems.length-1;t>=0;t--)this.removeSystem(this.systems[t])}}/**
 * The World is a self-contained entity component system for a particular context.
 */class rn{/**
     * The context type is passed to the system updates
     * @param context
     */constructor(t){this.context=t,this.queryManager=new rs(this),this.entityManager=new rt(this),this.systemManager=new rr(this)}/**
     * Update systems by type and time elapsed in milliseconds
     */update(t,e){t===to.Update&&this.entityManager.updateEntities(this.context,e),this.systemManager.updateSystems(t,this.context,e),this.entityManager.findEntitiesForRemoval(),this.entityManager.processComponentRemovals(),this.entityManager.processEntityRemovals()}add(t){t instanceof so&&this.entityManager.addEntity(t),t instanceof s3&&this.systemManager.addSystem(t)}remove(t,e=!0){t instanceof so&&this.entityManager.removeEntity(t,e),t instanceof s3&&this.systemManager.removeSystem(t)}clearEntities(){this.entityManager.clear()}clearSystems(){this.systemManager.clear()}}class ro{static integrate(t,e,i,s){let r=s/1e3;// This code looks a little wild, but it's to avoid creating any new Vector instances
// integration is done in a tight loop so this is key to avoid GC'ing
e.vel.addEqual(i.scale(r,ro._ACC)),t.pos.add(e.vel.scale(r,ro._VEL),ro._POS).addEqual(i.scale(.5*r*r,ro._VEL_ACC)),e.angularVelocity+=e.torque*(1/e.inertia)*r;let n=t.rotation+e.angularVelocity*r;t.scale.add(e.scaleFactor.scale(r,this._SCALE_FACTOR),ro._SCALE);let o=t.get();o.setTransform(ro._POS,n,ro._SCALE)}}// Scratch vectors to avoid allocation
ro._POS=new eg(0,0),ro._SCALE=new eg(1,1),ro._ACC=new eg(0,0),ro._VEL=new eg(0,0),ro._VEL_ACC=new eg(0,0),ro._SCALE_FACTOR=new eg(0,0);class ra extends s3{constructor(){super(...arguments),this.types=["ex.transform","ex.motion"],this.systemType=to.Update,this.priority=-1}update(t,e){let i,s;for(let r=0;r<t.length;r++){i=t[r].get(iW),s=t[r].get(iV);let n=t[r].get(st);if(null==n?void 0:n.sleeping)continue;let o=s.acc.clone();(null==n?void 0:n.collisionType)===Z.Active&&(null==n?void 0:n.useGravity)&&o.addEqual(iM.gravity),null==n||n.captureOldTransform(),// Update transform and motion based on Euler linear algebra
ro.integrate(i,s,o,e)}}}/**
 * ArcadeSolver is the default in Excalibur. It solves collisions so that there is no overlap between contacts,
 * and negates velocity along the collision normal.
 *
 * This is usually the type of collisions used for 2D games that don't need a more realistic collision simulation.
 *
 */class rh{constructor(){this.directionMap=new Map,this.distanceMap=new Map}solve(t){for(let e of(// Events and init
...
e.colliderA.events.emit("precollision",new tX(e.colliderA,e.colliderB,t,i)),e.colliderB.events.emit("precollision",new tX(e.colliderB,e.colliderA,V.getOpposite(t),i.negate()))}}postSolve(t){var e,i;for(let s of t){if(s.isCanceled())continue;let t=s.colliderA,r=s.colliderB,n=null===(e=t.owner)||void 0===e?void 0:e.get(st),o=null===(i=r.owner)||void 0===i?void 0:i.get(st);if(n&&o&&(n.collisionType===Z.Passive||o.collisionType===Z.Passive))continue;let a=V.fromDirection(s.mtv),h=s.mtv.negate();// Publish collision events on both participants
...
t.cancel();return}let s=t.mtv,r=t.colliderA,n=t.colliderB,o=null===(e=r.owner)||void 0===e?void 0:e.get(st),a=null===(i=n.owner)||void 0===i?void 0:i.get(st);if(o&&a){if(o.collisionType===Z.Passive||a.collisionType===Z.Passive)return;o.collisionType===Z.Active&&a.collisionType===Z.Active&&(s=s.scale(.5)),o.collisionType===Z.Active&&(o.globalPos.x-=s.x,o.globalPos.y-=s.y,r.update(o.transform.get())),a.collisionType===Z.Active&&(a.globalPos.x+=s.x,a.globalPos.y+=s.y,n.update(a.transform.get()))}}solveVelocity(t){var e,i;if(t.isCanceled())return;let s=t.colliderA,r=t.colliderB,n=null===(e=s.owner)||void 0===e?void 0:e.get(st),o=null===(i=r.owner)||void 0===i?void 0:i.get(st);if(n&&o){if(n.collisionType===Z.Passive||o.collisionType===Z.Passive)return;let e=t.normal,i=e.negate();if(n.collisionType===Z.Active&&0>n.vel.normalize().dot(i)){// Cancel out velocity opposite direction of collision normal
 ...
 */class rl{constructor(t,e,i){this.point=t,this.local=e,this.contact=i,/**
     ...
     */update(){var t,e;let i=null===(t=this.contact.colliderA.owner)||void 0===t?void 0:t.get(st),s=null===(e=this.contact.colliderB.owner)||void 0===e?void 0:e.get(st);if(i&&s){let t=this.contact.normal,e=this.contact.tangent;this.aToContact=this.point.sub(i.globalPos),this.bToContact=this.point.sub(s.globalPos);let r=this.aToContact.cross(t),n=this.bToContact.cross(t);this.normalMass=i.inverseMass+s.inverseMass+i.inverseInertia*r*r+s.inverseInertia*n*n;let o=this.aToContact.cross(e),a=this.bToContact.cross(e);this.tangentMass=i.inverseMass+s.inverseMass+i.inverseInertia*o*o+s.inverseInertia*a*a}return this}/**
     * Returns the relative velocity between bodyA and bodyB
     */getRelativeVelocity(){var t,e;let i=null===(t=this.contact.colliderA.owner)||void 0===t?void 0:t.get(st),s=null===(e=this.contact.colliderB.owner)||void 0===e?void 0:e.get(st);if(i&&s){// Relative velocity in linear terms
// Angular to linear velocity formula -> omega = velocity/radius so omega x radius = velocity
let t=i.vel.add(eg.cross(i.angularVelocity,this.aToContact)),e=s.vel.add(eg.cross(s.angularVelocity,this.bToContact));return e.sub(t)}return eg.Zero}}class rd{constructor(){this.lastFrameContacts=new Map,// map contact id to contact points
...
let t=r.indexOf(n.id);t>-1&&r.splice(t,1);let o=null!==(e=this.idToContactConstraint.get(n.id))&&void 0!==e?e:[],a=0,h=n.colliderA.owner.get(st),l=n.colliderB.owner.get(st);if(h&&l)for(let t of n.points){let e=n.normal,r=n.tangent,d=t.sub(h.globalPos),c=t.sub(l.globalPos),u=d.cross(e),p=c.cross(e),_=h.inverseMass+l.inverseMass+h.inverseInertia*u*u+l.inverseInertia*p*p,g=d.cross(r),m=c.cross(r),f=h.inverseMass+l.inverseMass+h.inverseInertia*g*g+l.inverseInertia*m*m;o[a]&&(null===(s=null===(i=o[a])||void 0===i?void 0:i.point)||void 0===s?void 0:s.squareDistance(t))<4?(o[a].point=t,o[a].local=n.localPoints[a]):o[a]=new rl(t,n.localPoints[a],n),// Update contact point calculations
...
if(iM.warmStart)this.warmStart(t);else for(let e of t){let t=this.getContactConstraints(e.id);for(let e of t)e.normalImpulse=0,e.tangentImpulse=0}}postSolve(t){for(let e of t){let t=e.colliderA.owner.get(st),i=e.colliderB.owner.get(st);if(t&&i){// Skip post solve for active+passive collisions
...
let i=e.getRelativeVelocity(),s=i.dot(r.normal),o=-e.normalMass*(s-e.originalVelocityAndRestitution),a=Math.max(e.normalImpulse+o,0);o=a-e.normalImpulse,e.normalImpulse=a;let h=r.normal.scale(o);t.applyImpulse(e.point,h.negate()),n.applyImpulse(e.point,h)}}}}}class rc extends s3{constructor(t){super(),this.types=["ex.transform","ex.motion","ex.collider"],this.systemType=to.Update,this.priority=-1,this._realisticSolver=new rd,this._arcadeSolver=new rh,this._lastFrameContacts=new Map,this._currentFrameContacts=new Map,this._processor=t.collisionProcessor,this._trackCollider=t=>this._processor.track(t),this._untrackCollider=t=>this._processor.untrack(t)}notify(t){if(s9(t)){let e=t.data.get(i8);e.$colliderAdded.subscribe(this._trackCollider),e.$colliderRemoved.subscribe(this._untrackCollider);let i=e.get();i&&this._processor.track(i)}else{let e=t.data.get(i8),i=e.get();e&&i&&this._processor.untrack(i)}}initialize(t){this._engine=t.engine}update(t,e){var i,s,r,n;if(!iM.enabled)return;// Collect up all the colliders and update them
let o=[];for(let e of t){let t=e.get(i8),s=null==t?void 0:t.get();if(t&&(null===(i=t.owner)||void 0===i?void 0:i.active)&&s){if(t.update(),s instanceof iQ){let t=s.getColliders();o=o.concat(t)}else o.push(s)}}// Update the spatial partitioning data structures
...
for(let[t,e]of this._lastFrameContacts)if(!this._currentFrameContacts.has(t)){let t=e.colliderA,i=e.colliderB;t.events.emit("collisionend",new tJ(t,i)),t.events.emit("contactend",new tY(t,i)),i.events.emit("collisionend",new tJ(i,t)),i.events.emit("contactend",new tY(i,t))}}}/**
     ...
     */P.Freeze="freeze";let ru={Frame:"frame",Loop:"loop",End:"end"};/**
...
let t=!!this._reversed&&1===this._pingPongDirection;return t?ta.Backward:ta.Forward}/**
     ...
     */tick(t,e=0){this._idempotencyToken!==e&&(this._idempotencyToken=e,this._playing&&(this._firstTick&&(this._firstTick=!1,this.events.emit("frame",{...this.currentFrame,frameIndex:this.currentFrameIndex})),this._timeLeftInFrame-=t*this.timeScale,this._timeLeftInFrame<=0&&this.goToFrame(this._nextFrame())))}_drawImage(t,e,i){this.currentFrame&&this.currentFrame.graphic.draw(t,e,i)}}Animation._LOGGER=t7.getInstance();class rp extends eM{constructor(t){super(t),this.members=[],this.members=t.members,this._updateDimensions()}clone(){return new rp({members:[...this.members],...this.cloneGraphicOptions()})}_updateDimensions(){let t=new ex;for(let{graphic:e,pos:i}of this.members)t=e.localBounds.translate(i).combine(t);return this.width=t.width,this.height=t.height,t}get localBounds(){let t=new ex;for(let{graphic:e,pos:i}of this.members)t=e.localBounds.translate(i).combine(t);return t}_isAnimationOrGroup(t){return t instanceof Animation||t instanceof rp}tick(t,e){for(let i of this.members){let s=i.graphic;this._isAnimationOrGroup(s)&&s.tick(t,e)}}reset(){for(let t of this.members){let e=t.graphic;this._isAnimationOrGroup(e)&&e.reset()}}_preDraw(t,e,i){this._updateDimensions(),super._preDraw(t,e,i)}_drawImage(t,e,i){for(let s of this.members)t.save(),t.translate(e,i),s.graphic.draw(t,s.pos.x,s.pos.y),this.showDebug&&/* istanbul ignore next */t.debug.drawRect(0,0,this.width,this.height),t.restore()}}/**
...
if(s.hasTag("ex.offscreen")||!(i=s.get(sd)).visible)continue;t.coordPlane===$.Screen&&this._graphicsContext.restore(),this._graphicsContext.save(),t.coordPlane===$.Screen&&this._graphicsContext.translate(this._engine.screen.contentArea.left,this._engine.screen.contentArea.top),// Tick any graphics state (but only once) for animations and graphics groups
i.update(e,this._token);// Apply parallax
let r=s.get(sW);if(r){// We use the Tiled formula
...
let n=s instanceof rm?s.opacity:1;this._graphicsContext.opacity*=i.opacity*n,// Draw the graphics component
...
o.flipHorizontal=s?!u:u,o.flipVertical=r?!p:p),null==o||o.draw(this._graphicsContext,d+n.offset.x,c+n.offset.y),(s||r)&&(o.flipHorizontal=u,o.flipVertical=p),(null===(e=this._engine)||void 0===e?void 0:e.isDebug)&&this._engine.debug.graphics.showBounds){let t=em(d+n.offset.x,c+n.offset.y);if(o instanceof rp)for(let e of o.members)null===(i=e.graphic)||void 0===i||i.localBounds.translate(t.add(e.pos)).draw(this._graphicsContext,this._engine.debug.graphics.boundsColor);else /* istanbul ignore next */null==o||o.localBounds.translate(t).draw(this._graphicsContext,this._engine.debug.graphics.boundsColor)}}}}/**
     * This applies the current entity transform to the graphics context
     * @param entity
     */_applyTransform(t){let e=t.getAncestors();for(let t of e){let e=null==t?void 0:t.get(iW),i=null==t?void 0:t.get(st),s=e.pos,r=e.scale,n=e.rotation;if(i&&this._engine.fixedUpdateFps&&i.__oldTransformCaptured&&i.enableFixedUpdateInterpolate){// Interpolate graphics if needed
 ...
 */class ry extends s3{constructor(){super(...arguments),this.types=["ex.transform","ex.pointer"],this.systemType=to.Update,this.priority=-1,/**
...
for(let o of t){if(i=o.get(iW),n=null!==(e=o.get(sp))&&void 0!==e?e:new sp,// Check collider contains pointer
(s=o.get(i8))&&(n.useColliderShape||this.overrideUseColliderShape)){s.update();let t=s.get();if(t)for(let[e,s]of this._receiver.currentFramePointerCoords.entries())t.contains(i.coordPlane===$.World?s.worldPos:s.screenPos)&&this.addPointerToEntity(o,e)}if(// Check graphics contains pointer
(r=o.get(sd))&&(n.useGraphicsBounds||this.overrideUseGraphicsBounds)){let t=r.localBounds.transform(i.get().matrix);for(let[e,s]of this._receiver.currentFramePointerCoords.entries())t.contains(i.coordPlane===$.World?s.worldPos:s.screenPos)&&this.addPointerToEntity(o,e)}}}_processDownAndEmit(t){let e=new Map;// Loop through down and dispatch to entities
...
for(let t of o){s=this._processDownAndEmit(t),i=this._processUpAndEmit(t),e=this._processMoveAndEmit(t);let r=[...e.values(),...s.values(),...i.values()];this._processEnterLeaveAndEmit(t,r),this._processCancelAndEmit(t),this._processWheelAndEmit(t)}}}class rw extends s3{constructor(){super(...arguments),this.types=["ex.actions"],this.systemType=to.Update,this.priority=-1,this._actions=[]}notify(t){if(s9(t)){let e=t.data.get(sk);this._actions.push(e)}else{let e=t.data.get(sk),i=this._actions.indexOf(e);i>-1&&this._actions.splice(i,1)}}update(t,e){for(let t of this._actions)t.update(e)}}class rb extends iO{/**
     ...
     */constructor(t){super(),this.type="ex.isometricentity",/**
         ...
         */this.elevation=0,this.map=t}}class rC extends s3{constructor(){super(...arguments),this.types=["ex.transform","ex.isometricentity"],this.systemType=to.Update,this.priority=99}update(t,e){let i,s;for(let e of t){i=e.get(iW),s=e.get(rb);let t=Math.max(s.map.columns*s.map.tileWidth,s.map.rows*s.map.tileHeight),r=t*s.elevation+i.pos.y;i.z=r}}}class rA extends s3{constructor(){super(...arguments),this.types=["ex.transform","ex.graphics"],this.systemType=to.Draw,this.priority=-1}initialize(t){this._camera=t.camera,this._screen=t.engine.screen}update(t){let e,i,s;for(let r of(this._worldBounds=this._screen.getWorldBounds(),t)){let t;if(i=r.get(sd),e=r.get(iW),s=r.get(sW)){// We use the Tiled formula
// https://doc.mapeditor.org/en/latest/manual/layers/#parallax-scrolling-factor
// cameraPos * (1 - parallaxFactor)
let e=eg.One.sub(s.parallaxFactor);t=this._camera.pos.scale(e)}// Figure out if entities are offscreen
let n=this._isOffscreen(e,i,t);n&&!r.hasTag("ex.offscreen")&&(r.events.emit("exitviewport",new t5(r)),r.addTag("ex.offscreen")),!n&&r.hasTag("ex.offscreen")&&(r.events.emit("enterviewport",new t4(r)),r.removeTag("ex.offscreen"))}}_isOffscreen(t,e,i){if(t.coordPlane!==$.World)return!1;{let s=e.localBounds;i&&(s=s.translate(i));let r=s.transform(t.get().matrix),n=!this._worldBounds.overlaps(r);return n}}}class rS{constructor(){this.collisionProcessor=new ij}rayCast(t,e){return this.collisionProcessor.rayCast(t,e)}}let rT={Initialize:"initialize",Activate:"activate",Deactivate:"deactivate",PreUpdate:"preupdate",PostUpdate:"postupdate",PreDraw:"predraw",PostDraw:"postdraw",PreDebugDraw:"predebugdraw",PostDebugDraw:"postdebugdraw"};/**
 ...
 */class rE{/**
     ...
     */get actors(){return this.world.entityManager.entities.filter(t=>t instanceof sU)}/**
     ...
     */get tileMaps(){return this.world.entityManager.entities.filter(t=>t instanceof sX)}get timers(){return this._timers}constructor(){// Initialize systems
this._logger=t7.getInstance(),this.events=new tS,/**
         * Gets or sets the current camera for the scene
         */this.camera=new s1,/**
         * The ECS world for the scene
         */this.world=new rn(this),/**
         ...
         */this.physics=new rS,this._isInitialized=!1,this._timers=[],this._cancelQueue=[],// Update
this.world.add(new rw),this.world.add(new ra),this.world.add(new rc(this.physics)),this.world.add(new ry),this.world.add(new rC),// Draw
this.world.add(new rA),this.world.add(new rv),this.world.add(new rx)}emit(t,e){this.events.emit(t,e)}on(t,e){return this.events.on(t,e)}once(t,e){return this.events.once(t,e)}off(t,e){this.events.off(t,e)}/**
...
this.emit("postdebugdraw",new tM(t,this))}/**
     ...
     */contains(t){return this.actors.indexOf(t)>-1}add(t){if(this.emit("entityadded",{target:t}),this.world.add(t),t.scene=this,t instanceof sH){eA(this._timers,t)||this.addTimer(t);return}}/**
     ...
     * @param entity
     */transfer(t){let e;t instanceof so&&t.scene&&t.scene!==this&&(e=t.scene,t.scene.world.remove(t,!1)),t instanceof sH&&t.scene&&(e=t.scene,t.scene.removeTimer(t)),null==e||e.emit("entityremoved",{target:t}),this.add(t)}remove(t){t instanceof so&&(this.emit("entityremoved",{target:t}),t.active&&t.kill(),this.world.remove(t)),t instanceof sH&&this.removeTimer(t)}/**
     ...
     */isTimerActive(t){return this._timers.indexOf(t)>-1&&!t.complete}isCurrentScene(){return!!this.engine&&this.engine.currentScene===this}_collectActorStats(t){let e=this.actors.filter(t=>t instanceof sN);for(let i of e)t.stats.currFrame.actors.ui++;for(let e of this.actors)for(let i of(t.stats.currFrame.actors.alive++,e.children))sO(i)?t.stats.currFrame.actors.ui++:t.stats.currFrame.actors.alive++}}(B=tc||(tc={})).Protanope="Protanope",B.Deuteranope="Deuteranope",B.Tritanope="Tritanope";/**
 ...
 */class rP{constructor(t,e){this._shader=new eZ({gl:t,vertexSource:`#version 300 es
      in vec2 a_position;
      in vec2 a_texcoord;
      out vec2 v_texcoord;
 ...
 */class rB{constructor(t){/**
         ...
         */this.camera={showAll:!1,showFocus:!1,focusColor:ef.Red,showZoom:!1},this._engine=t,this.colorBlindMode=new rD(this._engine)}/**
 ...
 */class rF{constructor(){this._id=0,this._delta=0,this._fps=0,this._actorStats={alive:0,killed:0,ui:0,get remaining(){return this.alive-this.killed},get total(){return this.remaining+this.ui}},this._durationStats={update:0,draw:0,get total(){return this.update+this.draw}},this._physicsStats=new rR,this._graphicsStats={drawCalls:0,drawnImages:0}}/**
     ...
     */clone(){let t=new rF;return t.reset(this),t}/**
     * Gets the frame's id
     ...
     * Provides a clone of this instance.
     */clone(){let t=new rR;return t.reset(this),t}get pairs(){return this._pairs}set pairs(t){this._pairs=t}get collisions(){return this._collisions}set collisions(t){this._collisions=t}get contacts(){return this._contacts}set contacts(t){this._contacts=t}get fastBodies(){return this._fastBodies}set fastBodies(t){this._fastBodies=t}get fastBodyCollisions(){return this._fastBodyCollisions}set fastBodyCollisions(t){this._fastBodyCollisions=t}get broadphase(){return this._broadphase}set broadphase(t){this._broadphase=t}get narrowphase(){return this._narrowphase}set narrowphase(t){this._narrowphase=t}}class rk{on(t,e){this._nativeHandlers[t]&&this.off(t,this._nativeHandlers[t]),this._nativeHandlers[t]=this._decorate(e),this.nativeComponent.addEventListener(t,this._nativeHandlers[t])}off(t,e){e||(e=this._nativeHandlers[t]),this.nativeComponent.removeEventListener(t,e),this._nativeHandlers[t]=null}_decorate(t){return e=>{this._paused||t(e)}}pause(){this._paused=!0}resume(){this._paused=!1}clear(){for(let t in this._nativeHandlers)this.off(t)}constructor(t){this.nativeComponent=t,this._paused=!1,this._nativeHandlers={}}}class rM{constructor(t,e){this._windowGlobal=t,this._documentGlobal=e,this._windowComponent=new rk(this._windowGlobal),this._documentComponent=new rk(this._documentGlobal)}get window(){return this._windowComponent}get document(){return this._documentComponent}pause(){this.window.pause(),this.document.pause()}resume(){this.window.resume(),this.document.resume()}clear(){this.window.clear(),this.document.clear()}}class rL{static fromPagePosition(t,e,i){let s,r;3==arguments.length?(s=new eg(t,e),r=i):((s=t).x,s.y,r=e);let n=r.screen.pageToScreenCoordinates(s),o=r.screen.screenToWorldCoordinates(n);return new rL(o,s,n)}constructor(t,e,i){this.worldPos=t,this.pagePos=e,this.screenPos=i}}class PointerEvent{cancel(){this.active=!1}get pagePos(){return this.coordinates.pagePos}get screenPos(){return this.coordinates.screenPos}get worldPos(){return this.coordinates.worldPos}constructor(t,e,i,s,r,n){this.type=t,this.pointerId=e,this.button=i,this.pointerType=s,this.coordinates=r,this.nativeEvent=n,this.active=!0}}class WheelEvent{cancel(){this.active=!1}constructor(t,e,i,s,r,n,o,a,h,l,d,c){this.x=t,this.y=e,this.pageX=i,this.pageY=s,this.screenX=r,this.screenY=n,this.index=o,this.deltaX=a,this.deltaY=h,this.deltaZ=l,this.deltaMode=d,this.ev=c,this.active=!0}}class rz{constructor(){this.events=new tS,/**
...
let s=this.engine.currentScene.world.systemManager.get(ry),r=this.engine.currentScene.world.queryManager.createQuery(s.types);s.preupdate(),s.update(r.getEntities())}_nativeButtonToPointerButton(t){switch(t){case tp.NoButton:return t_.NoButton;case tp.Left:return t_.Left;case tp.Middle:return t_.Middle;case tp.Right:return t_.Right;case tp.Unknown:return t_.Unknown;default:return eS(t)}}_stringToPointerType(t){switch(t){case"touch":return tg.Touch;case"mouse":return tg.Mouse;case"pen":return tg.Pen;default:return tg.Unknown}}}class rO{constructor(t){var e;this._samplePeriod=100,this._currentFrameTime=0,this._frames=0,this._previousSampleTime=0,this._beginFrameTime=0,this._fps=t.initialFps,this._samplePeriod=null!==(e=t.samplePeriod)&&void 0!==e?e:this._samplePeriod,this._currentFrameTime=1e3/t.initialFps,this._nowFn=t.nowFn,this._previousSampleTime=this._nowFn()}/**
 ...
 */class rN{constructor(t){var e,i,s;this._onFatalException=()=>{},this._maxFps=1/0,this._lastTime=0,this._elapsed=1,this._scheduledCbs=[],this._totalElapsed=0,this._options=t,this.tick=t.tick,this._lastTime=null!==(e=this.now())&&void 0!==e?e:0,this._maxFps=null!==(i=t.maxFps)&&void 0!==i?i:this._maxFps,this._onFatalException=null!==(s=t.onFatalException)&&void 0!==s?s:this._onFatalException,this.fpsSampler=new rO({initialFps:60,nowFn:()=>this.now()})}/**
     * Get the elapsed time for the last completed frame
     */elapsed(){return this._elapsed}/**
     * Get the current time in milliseconds
     */now(){return performance.now()}toTestClock(){let t=new rW({...this._options,defaultUpdateMs:16.6});return t}toStandardClock(){let t=new rH({...this._options});return t}setFatalExceptionHandler(t){this._onFatalException=t}/**
 ...
 */class rH extends rN{constructor(t){super(t),this._running=!1}isRunning(){return this._running}start(){if(this._running)return;this._running=!0;let t=()=>{// stop the loop
 ...
 */class rW extends rN{constructor(t){super({...t}),this._logger=t7.getInstance(),this._running=!1,this._currentTime=0,this._updateMs=t.defaultUpdateMs}/**
     * Get the current time in milliseconds
 ...
 */class rq{constructor(t){this.inputs=t,this._handlers=new Map}/**
     ...
     */on(t,e){this._handlers.set(t,e)}}tb();let rX={FallbackGraphicsContext:"fallbackgraphicscontext",Initialize:"initialize",Visible:"visible",Hidden:"hidden",Start:"start",Stop:"stop",PreUpdate:"preupdate",PostUpdate:"postupdate",PreFrame:"preframe",PostFrame:"postframe",PreDraw:"predraw",PostDraw:"postdraw"};/**
 ...
 */class rZ{/**
     ...
     */constructor(t){var e,i,s,r,n,o;/**
         ...
         */this.onFatalException=t=>{t7.getInstance().fatal(t)},this._toaster=new rG,this._timescale=1,this._isInitialized=!1,this._deferredGoTo=null,this._originalOptions={},this._performanceThresholdTriggered=!1,this._fpsSamples=[],this._loadingComplete=!1,this._isReady=!1,this._isReadyPromise=new Promise(t=>{this._isReadyResolve=t}),/**
         ...
         */this.currentFrameLagMs=0,this._lagMs=0,this._screenShotRequests=[],t={...rZ._DEFAULT_ENGINE_OPTIONS,...t},this._originalOptions=t,tC.freeze(),// Initialize browser events facade
this.browser=new rM(window,document);// Check compatibility
...
let n=t&&t.pointerScope===W.Document?document:this.canvas;this.input={keyboard:new es,pointers:new rU(n,this),gamepads:new t9},this.input.keyboard.init({grabWindowFocus:null===(i=null===(e=this._originalOptions)||void 0===e?void 0:e.grabWindowFocus)||void 0===i||i}),this.input.pointers.init({grabWindowFocus:null===(r=null===(s=this._originalOptions)||void 0===s?void 0:s.grabWindowFocus)||void 0===r||r}),this.input.gamepads.init(),this.inputMapper=new rq(this.input),// Issue #385 make use of the visibility api
 ...
 */class rY extends sU{get font(){return this._font}set font(t){this._font=t,this._text.font=t}/**
     * The text to draw.
     ...
     * Build a new label
     * @param options
     */constructor(t){super(t),this._font=new sz,this._text=new Text({text:"",font:this._font});let{text:e,pos:i,x:s,y:r,spriteFont:n,font:o,color:a}=t;this.pos=null!=i?i:s&&r?em(s,r):this.pos,this.text=null!=e?e:this.text,this.font=null!=o?o:this.font,this.spriteFont=null!=n?n:this.spriteFont,this._text.color=null!=a?a:this.color;let h=this.get(sd);h.anchor=eg.Zero,h.use(this._text)}_initialize(t){super._initialize(t)}/**
     * Returns the width of the text in the label (in pixels);
     */getTextWidth(){return this._text.width}}class rj extends so{getGraphics(){return this._graphics}/**
     * Tile graphics
 ...
 * your art assets.
 */class r$ extends so{constructor(t){super([new iW,new st({type:Z.Fixed}),new i8,new sV(t=>this.debug(t),!1)],t.name),/**
         * Render the tile graphic from the top instead of the bottom
         *
         * default is `false` meaning rendering from the bottom
         */this.renderFromTopOfGraphic=!1,this.graphicsOffset=em(0,0),this._collidersDirty=!1,this._originalOffsets=new WeakMap;let{pos:e,tileWidth:i,tileHeight:s,columns:r,rows:n,renderFromTopOfGraphic:o,graphicsOffset:a}=t;this.transform=this.get(iW),e&&(this.transform.pos=e),this.collider=this.get(i8),this.collider&&this.collider.set(this._composite=new iQ([])),this.renderFromTopOfGraphic=null!=o?o:this.renderFromTopOfGraphic,this.graphicsOffset=null!=a?a:this.graphicsOffset,this.tileWidth=i,this.tileHeight=s,this.columns=r,this.rows=n,this.tiles=Array(r*n);// build up tile representation
for(let t=0;t<n;t++)for(let e=0;e<r;e++){let i=new rj(e,t,this.graphicsOffset,this);this.tiles[e+t*r]=i,this.addChild(i);// TODO row/columns helpers
 ...
 */class rQ{constructor(t,e){this._stopped=!1,this._sequenceBuilder=e,this._sequenceContext=new sR(t),this._actionQueue=this._sequenceContext.getQueue(),this._sequenceBuilder(this._sequenceContext)}update(t){this._actionQueue.update(t)}isComplete(){return this._stopped||this._actionQueue.isComplete()}stop(){this._stopped=!0}reset(){this._stopped=!1,this._actionQueue.reset()}clone(t){return new rQ(t,this._sequenceBuilder)}}/**
 * Action that can run multiple [[Action]]s or [[ActionSequence]]s at the same time
 */class rJ{constructor(t){this._actions=t}update(t){for(let e=0;e<this._actions.length;e++)this._actions[e].update(t)}isComplete(t){return this._actions.every(e=>e.isComplete(t))}reset(){this._actions.forEach(t=>t.reset())}stop(){this._actions.forEach(t=>t.stop())}}/**
 * Static class for managing collision groups in excalibur, there is a maximum of 32 collision groups possible in excalibur
 */class r0{/**
     * Create a new named collision group up to a max of 32.
     * @param name Name for the collision group
     * @param mask Optionally provide your own 32-bit mask, if none is provide the manager will generate one
     */static create(t,e){if(this._CURRENT_GROUP>this._MAX_GROUPS)throw Error(`Cannot have more than ${this._MAX_GROUPS} collision groups`);if(this._GROUPS.get(t))throw Error(`Collision group ${t} already exists`);let i=new iG(t,this._CURRENT_BIT,void 0!==e?e:~this._CURRENT_BIT);return this._CURRENT_BIT=this._CURRENT_BIT<<1|0,this._CURRENT_GROUP++,this._GROUPS.set(t,i),i}/**
 ...
 *
 */function r7(t){return!!t.onPostDraw}// using bitmasking the maximum number of groups is 32, because that is the highest 32bit integer that JS can present.
r0._STARTING_BIT=1,r0._MAX_GROUPS=32,r0._CURRENT_GROUP=1,r0._CURRENT_BIT=r0._STARTING_BIT,r0._GROUPS=new Map;/**
 ...
 */let nl="0.28.2";tb();// This file is used as the bundle entry point and exports everything
...
//# sourceMappingURL=index.ed1cdc69.js.map
