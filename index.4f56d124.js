...
if(this._isFullScreen||(e-=eb(this._canvas).x,i-=eb(this._canvas).y),this._isFullScreen){if(window.innerWidth/this.aspectRatio<window.innerHeight){let t=window.innerWidth/this.aspectRatio,s=(window.innerHeight-t)/2;i=(i-s)/t*this.viewport.height,e=e/window.innerWidth*this.viewport.width}else{let t=window.innerHeight*this.aspectRatio,s=(window.innerWidth-t)/2;e=(e-s)/t*this.viewport.width,i=i/window.innerHeight*this.viewport.height}}return new em(e=e/this.viewport.width*this.resolution.width,i=i/this.viewport.height*this.resolution.height)}/**
...
//# sourceMappingURL=index.4f56d124.js.map
